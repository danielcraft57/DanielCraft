---
title: "Comment créer un assistant IA gratuit avec Gemini l'IA de"
date: 2026-06-07
excerpt: "Google vient de donner à n'importe qui la possibilité de créer un assistant IA sans coder et c'est gratuit. Il suffit d'aller sur le site de Gemini, puis de cliquer sur « Découvrir les Gems »."
type: tutorial
tags: [IA, Gemini, NotebookLM, Google]
og_image: ia-gemini-comment-creer-un-assistant-ia-gratuit-avec-gemini-l-ia-de-1200x630.jpg
series: ia-gemini-serie
series_order: 2
---
# Comment créer un assistant IA gratuit avec Gemini l'IA de

On avance étape par étape. L'idée c'est que tu puisses le refaire sans revenir dix fois dans la video d'origine.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-gemini-comment-creer-un-assistant-ia-gratuit-avec-gemini-l-ia-de-banner.webp" alt="Illustration : Comment créer un assistant IA gratuit avec Gemini l'IA de" class="schema-inline" width="720" loading="lazy" />
...
Google vient de donner à n'importe qui la possibilité de créer un assistant IA sans coder et c'est gratuit.
...
Il suffit d'aller sur le site de Gemini, puis de cliquer sur « Découvrir les Gems ».
...
Sur le sujet **Comment créer un assistant IA gratuit avec Gemini l'IA de**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
