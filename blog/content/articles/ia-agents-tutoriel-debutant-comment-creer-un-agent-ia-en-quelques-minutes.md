...
<figure class="schema-figure">
  <img src="/assets/images/blog/schemas/ia-agents-base.svg" alt="Schema agent debutant" class="schema-inline" width="640" />
  <figcaption>But, outils, regles, test, corriger.</figcaption>
</figure>
...
Tutoriel débutant : comment créer un agent IA en quelques minutes
...
Si vous pensez que créer un agent IA c'est trop long et trop compliqué, regardez ça.
### Étape 4
...
Il suffit d'aller sur ce site, de cliquer sur Wingman, pour créer un agent IA personnalisé.
...
Sur le sujet **Tutoriel débutant : comment créer un agent IA en quelques minutes**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
