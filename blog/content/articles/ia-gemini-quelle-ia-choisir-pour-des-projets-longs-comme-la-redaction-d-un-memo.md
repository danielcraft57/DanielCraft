---
title: "Quelle IA choisir pour des projets longs comme la rédaction d'un mémo"
date: 2026-06-16
excerpt: "Si jamais vous utilisez ChatGPT pour un projet assez long, genre rédaction d'un mémoire, rapport d'analyse ou juste projet de code, ChatGPT aura peut-être tendance à oublier certaines infos."
type: tutorial
...
series_order: 9
---
# Quelle IA choisir pour des projets longs comme la rédaction d'un mémo

On avance étape par étape. L'idée c'est que tu puisses le refaire sans revenir dix fois dans la video d'origine.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-gemini-quelle-ia-choisir-pour-des-projets-longs-comme-la-redaction-d-un-memo-banner.webp" alt="Illustration : Quelle IA choisir pour des projets longs comme la rédaction d'un mémo" class="schema-inline" width="720" loading="lazy" />
...
Si jamais vous utilisez ChatGPT pour un projet assez long, genre rédaction d'un mémoire, rapport d'analyse ou juste projet de code, ChatGPT aura peut-être tendance à oublier certaines infos. En fait, c'est parce que une IA comme ChatGPT a un nombre maximal de mots qu'elle…
### On avance étape par étape

On avance étape par étape. Prends le temps de faire chaque point avant de passer au suivant.
### Étape 5

Si jamais vous utilisez ChatGPT pour un projet assez long, genre rédaction d'un mémoire, rapport d'analyse ou juste projet de code, ChatGPT aura peut-être tendance à oublier certaines infos. En fait, c'est parce que une IA comme ChatGPT a un nombre maximal de mots qu'elle peut gérer en une seule conversation. Si vous utilisez GPT
### 0, par exemple, vous allez voir que vous êtes limité à
...
Sur le sujet **Quelle IA choisir pour des projets longs comme la rédaction d'un mémo**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
