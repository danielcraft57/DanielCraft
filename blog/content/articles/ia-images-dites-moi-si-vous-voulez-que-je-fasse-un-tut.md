---
title: "Tutoriel image IA : par ou commencer"
date: 2026-07-07
excerpt: "Un parcours simple pour ton premier rendu propre."
type: tutorial
tags: [IA, images, design, visuels]
og_image: ia-images-dites-moi-si-vous-voulez-que-je-fasse-un-tut-1200x630.jpg
...
<figure class="schema-figure">
  <img src="/assets/images/blog/schemas/ia-images-gen.svg" alt="Schema premier tutoriel image" class="schema-inline" width="640" />
  <figcaption>Etapes debutant.</figcaption>
</figure>
...
Dites-moi si vous voulez que je fasse un tut
...
C'était temps que je m'intéresse vraiment à la génération d'images par intelligence artificielle et donc ça passe par le fait de comprendre ce qu'est un LoRa et surtout d'essayer d'en créer un pour pouvoir l'utiliser. Je suis sûre qu'évidemment je ne savais pas comment faire…
### On avance étape par étape

On avance étape par étape. Prends le temps de faire chaque point avant de passer au suivant.
### Étape 5

C'était temps que je m'intéresse vraiment à la génération d'images par intelligence artificielle et donc ça passe par le fait de comprendre ce qu'est un LoRa et surtout d'essayer d'en créer un pour pouvoir l'utiliser. Je suis sûre qu'évidemment je ne savais pas comment faire et qu'est-ce qu'on fait quand on ne sait pas faire quelque chose, on va sur YouTube et on trouve le tutoriel d'un ingénieur idéalement indien. J'ai donc suivi ce tutoriel qui est très très bien expliqué et en dix minutes il vous dit vraiment comment faire mais pour vraiment vous expliquer la théorie LoRa ça veut dire Low-Rank Adaptation. En fait c'est une technique qui vous permet d'entraîner un modèle d'intelligence artificielle à partir de vos données. Donc je lui ai donné genre
### 45 photos de moi et à partir de ma tête il a fait des illustrations

45 photos de moi et à partir de ma tête il a fait des illustrations. Bref tout allait bien jusqu'au moment où je me suis dit ok maintenant je vais essayer de demander des photos plus réalistes et genre ça on dirait vraiment moi en un peu plus fatigué que d'habitude mais surtout celle-ci les gars on dirait vraiment ma tête c'est trop bizarre.
...
Sur le sujet **Dites-moi si vous voulez que je fasse un tut**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
