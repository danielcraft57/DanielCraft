---
title: "Resume YouTube : donner le lien a ChatGPT"
date: 2026-05-17
excerpt: "Gagner du temps sur une video longue : resume + points cles, puis verifier."
type: tutorial
tags: [IA, ChatGPT, productivite, astuces]
og_image: ia-chatgpt-astuce-pour-que-chatgpt-resume-des-videos-youtube-en-utilisant-l-url-1200x630.jpg
series: ia-chatgpt-serie
series_order: 3
---
...
<figure class="schema-figure">
  <img src="/assets/images/blog/schemas/ia-chatgpt-youtube.svg" alt="Schema resume video YouTube" class="schema-inline" width="640" />
  <figcaption>Lien, demande, resume, points cles, verif.</figcaption>
</figure>
...
Astuce pour que ChatGPT résume des vidéos YouTube en utilisant l'url
...
Jusqu'à présent, pour résumer des vidéos YouTube, on était nombreux à utiliser l'astuce de copier-coller le script dans le ChatGPT. Donc c'est tout simple, on allait sur notre vidéo YouTube, affiché plus, puis dans la description, affiché la transcription, et là on avait…
### On avance étape par étape

On avance étape par étape. Prends le temps de faire chaque point avant de passer au suivant.
### Étape 4

Jusqu'à présent, pour résumer des vidéos YouTube, on était nombreux à utiliser l'astuce de copier-coller le script dans le ChatGPT. Donc c'est tout simple, on allait sur notre vidéo YouTube, affiché plus, puis dans la description, affiché la transcription, et là on avait juste à copier-coller tout ce texte, ce qui peut rendre un petit peu de temps, surtout quand la vidéo est longue.
### Étape 5

Ensuite on a juste à coller le script et à lui dire de nous résumer la vidéo. Donc évidemment ça marche très bien, mais il y a une façon un peu plus simple et un peu plus rapide. Vous avez juste à commencer un nouveau Chat et appuyez sur ce bouton de recherche sur le web.
### Étape 6

Ensuite tu peux coller le lien de la vidéo YouTube et je lui demandais la même chose, de me résumer la vidéo en
...
Sur le sujet **Astuce pour que ChatGPT résume des vidéos YouTube en utilisant l’url**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
...
## Utiliser ChatGPT sans tourner en rond

ChatGPT brille quand tu lui donnes un cadre. Un mini template qui marche souvent :

1. **Rôle** : qui doit-il incarner ?
2. **Contexte** : pour qui, quelle contrainte ?
3. **Objectif** : le résultat attendu en 1 phrase.
4. **Format** : liste, tableau, mail, plan...
5. **Critère de qualité** : court, clair, actionnable, etc.

### Astuce memoire / projets

Si tu refais souvent la même chose, range-la dans un Project ou un GPT dédié. Évite le chat interminable ou tout se mélange.
