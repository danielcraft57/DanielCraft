---
title: "Comment accéder aux 5 IA secrètes de Whatsapp Merci @Jolan.ai d'avoi"
date: 2026-07-06
excerpt: "Comment accéder aux 5 IA secrètes de WhatsApp ?"
type: tutorial
tags: [IA, images, design, visuels]
og_image: ia-images-comment-acceder-aux-5-ia-secretes-de-whatsapp-merci-jolan-ai-d-avoi-1200x630.jpg
series: ia-images-serie
series_order: 7
---

# Comment accéder aux 5 IA secrètes de Whatsapp Merci @Jolan.ai d'avoi

On avance étape par étape. L'idée c'est que tu puisses le refaire sans revenir dix fois dans la video d'origine.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-images-comment-acceder-aux-5-ia-secretes-de-whatsapp-merci-jolan-ai-d-avoi-banner.webp" alt="Illustration : Comment accéder aux 5 IA secrètes de Whatsapp Merci @Jolan.ai d'avoi" class="schema-inline" width="720" loading="lazy" />
...
### Comment accéder aux 5 IA secrètes de Whatsapp Merci @Jolan
...
### 5 IA secrètes de WhatsApp ? J'y croyais pas, mais en fait ça marche

5 IA secrètes de WhatsApp ? J'y croyais pas, mais en fait ça marche. Vous avez juste à appuyer sur ce bouton pour créer un nouveau contact. Là il faudra entrer ce numéro et vous pourrez discuter directement avec Copilot, l'équivalent de ChatGPT, mais créé par Microsoft.…
### On avance étape par étape

On avance étape par étape. Prends le temps de faire chaque point avant de passer au suivant.
### 5 IA secrètes de WhatsApp ? J'y croyais pas, mais en fait ça marche

5 IA secrètes de WhatsApp ? J'y croyais pas, mais en fait ça marche. Vous avez juste à appuyer sur ce bouton pour créer un nouveau contact. Là il faudra entrer ce numéro et vous pourrez discuter directement avec Copilot, l'équivalent de ChatGPT, mais créé par Microsoft. D'ailleurs si vous préférez ChatGPT, il a aussi un numéro dans WhatsApp. je te le mets à l'écran, c'est à peu près la même chose que sur l'application, sauf que tout se fait dans WhatsApp.
### Étape 6

Ensuite avec ce numéro, tu peux accéder à Luzia, une IA espagnole. Elle peut transcrire des audios, traduire des textes, donner des conseils, donc super pratique si vous vous échangez avec des personnes dans différentes langues. Si vous cherchez un assistant pour mieux vous organisér, tu peux essayer DolaAI qui vous permettra de créer, de modifier ou de supprimer des événements directement dans votre calendrier. Et si tu veux plutôt créer des images, il y a aussi une IA pour ça. tu peux utiliser MobileGPT avec ce numéro pour générer des images directement dans WhatsApp. Ça vous évite d'accumuler les applications et vous avez tout au même endroit.
...
Sur le sujet **Comment accéder aux 5 IA secrètes de Whatsapp Merci @Jolan.ai d'avoi**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
