---
title: "Choisir une IA : 3 questions (pas un classement absolu)"
date: 2026-06-01
excerpt: "Ecrire, coder, chercher : choisis selon le job, pas selon le hype."
type: tutorial
tags: [IA, Claude, Anthropic, productivite]
og_image: ia-claude-mon-top-des-meilleures-3-ia-1200x630.jpg
series: ia-claude-serie
series_order: 8
---
...
<figure class="schema-figure">
  <img src="/assets/images/blog/schemas/ia-claude-top.svg" alt="Schema choix d'IA selon besoin" class="schema-inline" width="640" />
  <figcaption>Ecrire, coder, image, recherche…</figcaption>
</figure>
...
Si tu tournes autour de Claude en ce moment, voilà ce qui vaut vraiment le coup de tester.
...
Si tu tournes autour de Claude en ce moment, voilà ce qui vaut vraiment le coup de tester.
### 3 c'est ChatGPT, Claude, Perplexity et c'est tout

> Conseil : fais cette partie une fois sans viser parfait. Note ce qui bloque, puis recommence avec une consigne plus précise.


3 c'est ChatGPT, Claude, Perplexity et c'est tout. ChatGPT c'est la référence et c'est une IA qui est hyper polyvalente. Et d'un côté elle est très généraliste mais en même temps on peut vraiment la personnaliser lorsque l'on crée nos propres GPT. Pour moi c'est vraiment ça…
...
3 c'est ChatGPT, Claude, Perplexity et c'est tout. ChatGPT c'est la référence et c'est une IA qui est hyper polyvalente. Et d'un côté elle est très généraliste mais en même temps on peut vraiment la personnaliser lorsque l'on crée nos propres GPT. Pour moi c'est vraiment ça son point fort et c'est la seule IA que je paye.
### Étape 5

Ensuite Claude est très bien aussi. Je l'utilise moins que ChatGPT mais au niveau de la génération de texte ça a tendance à créer un résultat plus naturel et je code pas du tout mais IA a un consensus sur le fait que Claude est la meilleure IA pour générer du code. Et pour finir Perplexity, on en entend très peu parler mais moi c'est une IA qui a vraiment changé ma vie. En version gratuite ça suffit amplement, c'est un moteur de recherche qui rassemble toutes les informations les plus pertinentes pour une requête. Sans les pubs ou le SEO dégueulasse de Google qui nous force à scroller indéfiniment sur des pages.
...
Sur le sujet **Mon top des meilleures 3 IA**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
...
## Prendre Claude en main (sans se perdre)

Claude, c'est pas "ChatGPT en beige". Il est souvent plus à l'aise sur les longs textes, le code, et les consignes précises. Si tu debutes :

1. Ouvre un projet / espace dédié (pas un chat fourre-tout).
...
Une Skill, c'est un pack d'instructions réutilisable. Utile quand tu refais souvent la même tâche (audit, mail, résumé, brief). Les plugins, eux, branchent Claude a des outils (finance, docs, etc.). Commence simple : 1 skill claire > 10 gadgets.

### Passage depuis ChatGPT

Garde tes meilleurs prompts. Adapte juste le ton : Claude repond souvent mieux si tu précises le format de sortie (liste, tableau, étapes). Et oui, tu peux lui demander de reformuler un vieux prompt ChatGPT pour son style.
