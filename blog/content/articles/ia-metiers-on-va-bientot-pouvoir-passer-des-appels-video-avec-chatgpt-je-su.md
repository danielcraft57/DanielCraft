---
title: "Appels video avec ChatGPT : nouveau canal"
date: 2026-08-27
excerpt: "Oral + IA : pratique pour brainstorm, a cadrer pour le sensible."
type: article
tags: [IA, metiers, emploi, futur du travail]
og_image: ia-metiers-on-va-bientot-pouvoir-passer-des-appels-video-avec-chatgpt-je-su-1200x630.jpg
...
On va bientôt pouvoir passer des appels vidéo avec ChatGPT !!!! Je su
...
Je sais pas si on se rend compte à quel point les moments qu'on vit actuellement sont historiques.
### Point 4

Je sais pas si on se rend compte à quel point les moments qu'on vit actuellement sont historiques.
### Point 5

Là, j'ai terminé le live d'aujourd'hui d'OpenAI et en gros, tous les jours jusqu'à Noël, ils nous sortent une nouveauté.
### Et juste, je vais juste vous montrer en fait
...
Sur le sujet **On va bientôt pouvoir passer des appels vidéo avec ChatGPT !!!! Je su**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
