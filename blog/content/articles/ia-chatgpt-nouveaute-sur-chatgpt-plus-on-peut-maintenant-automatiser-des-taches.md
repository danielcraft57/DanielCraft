---
title: "ChatGPT : automatiser les taches qui se repetent"
date: 2026-05-20
excerpt: "Quand c'est toujours la meme demande, industrialise le prompt (et garde un oeil humain)."
type: tutorial
tags: [IA, ChatGPT, productivite, astuces]
og_image: ia-chatgpt-nouveaute-sur-chatgpt-plus-on-peut-maintenant-automatiser-des-taches-1200x630.jpg
...
<figure class="schema-figure">
  <img src="/assets/images/blog/schemas/ia-chatgpt-auto.svg" alt="Schema automatisation ChatGPT" class="schema-inline" width="640" />
  <figcaption>Idee, prompt fixe, declencheur, resultat, verifier.</figcaption>
</figure>
...
Nouveauté sur ChatGPT Plus, on peut maintenant automatiser des tâches
...
Ok, il y a une nouveauté sur ChatGPT, on peut maintenant l'utiliser pour automatiser des tâches. Donc moi je vais demander chaque matin à
...
8 heures de m'envoyer des actualités en lien avec l'intelligence artificielle et en théorie demain je devrais avoir une petite notification pour me donner toutes les actualités. On peut aussi créer des tâches ponctuelles comme par exemple un rappel pour un anniversaire et au niveau des notifications on peut choisir de recevoir ça par mail ou bien sur notre ordinateur. Bon, la fonctionnalité était encore en bêta donc il faut être patient et je pense qu'on est beaucoup à vouloir l'utiliser en même temps donc peut-être qu'elle ne fonctionnera pas tout de suite.
...
Sur le sujet **Nouveauté sur ChatGPT Plus, on peut maintenant automatiser des tâches**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
