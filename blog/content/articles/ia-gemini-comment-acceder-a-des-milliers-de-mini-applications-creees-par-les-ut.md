---
title: "Comment accéder à des milliers de mini applications créées par les ut"
date: 2026-06-17
excerpt: "Je suis prête à parier que vous ne saviez pas ça. Si vous allez sur ce site, vous aurez accès à toutes ces mini-applications qui ont été créées par les utilisateurs de Gemini."
type: tutorial
tags: [IA, Gemini, NotebookLM, Google]
og_image: ia-gemini-comment-acceder-a-des-milliers-de-mini-applications-creees-par-les-ut-1200x630.jpg
series: ia-gemini-serie
series_order: 10
---
# Comment accéder à des milliers de mini applications créées par les ut

On avance étape par étape. L'idée c'est que tu puisses le refaire sans revenir dix fois dans la video d'origine.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-gemini-comment-acceder-a-des-milliers-de-mini-applications-creees-par-les-ut-banner.webp" alt="Illustration : Comment accéder à des milliers de mini applications créées par les ut" class="schema-inline" width="720" loading="lazy" />
...
### Je suis prête à parier que vous ne saviez pas ça
...
Si vous allez sur ce site, vous aurez accès à toutes ces mini-applications qui ont été créées par les utilisateurs de Gemini.
...
Sur le sujet **Comment accéder à des milliers de mini applications créées par les ut**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
