---
title: "Comment utiliser l’IA chinoise gratuite et open source Deepseek en ve"
date: 2026-06-03
excerpt: "Bonne nouvelle, DeepSec est désormais disponible dans Perplexity. Perplexity est un moteur de recherche qui nous permet d'utiliser l'intelligence artificielle pour répondre à nos questions."
type: tutorial
tags: [IA, Claude, Anthropic, productivite]
og_image: ia-claude-comment-utiliser-l-ia-chinoise-gratuite-et-open-source-deepseek-en-ve-1200x630.jpg
series: ia-claude-serie
series_order: 10
---
# Comment utiliser l’IA chinoise gratuite et open source Deepseek en ve

On avance étape par étape. L'idée c'est que tu puisses le refaire sans revenir dix fois dans la video d'origine.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-claude-comment-utiliser-l-ia-chinoise-gratuite-et-open-source-deepseek-en-ve-banner.webp" alt="Illustration : Comment utiliser l’IA chinoise gratuite et open source Deepseek en ve" class="schema-inline" width="720" loading="lazy" />
...
### Bonne nouvelle, DeepSec est désormais disponible dans Perplexity
...
Perplexity est un moteur de recherche qui nous permet d'utiliser l'intelligence artificielle pour répondre à nos questions.
...
Sur le sujet **Comment utiliser l’IA chinoise gratuite et open source Deepseek en ve**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
