---
title: "Alerte formations IA gratuites par Google avec Google Skills Il y a p"
date: 2026-06-06
excerpt: "Je sais pas si vous êtes au courant, mais Google vient de sortir une liste de 1691 formations pour apprendre à utiliser l'IA et la plupart sont gratuites."
type: tutorial
tags: [IA, Gemini, NotebookLM, Google]
og_image: ia-gemini-alerte-formations-ia-gratuites-par-google-avec-google-skills-il-y-a-p-1200x630.jpg
series: ia-gemini-serie
series_order: 1
---
# Alerte formations IA gratuites par Google avec Google Skills Il y a p

On avance étape par étape. L'idée c'est que tu puisses le refaire sans revenir dix fois dans la video d'origine.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-gemini-alerte-formations-ia-gratuites-par-google-avec-google-skills-il-y-a-p-banner.webp" alt="Illustration : Alerte formations IA gratuites par Google avec Google Skills Il y a p" class="schema-inline" width="720" loading="lazy" />
...
Je sais pas si vous êtes au courant, mais Google vient de sortir une liste de
...
1691 formations pour apprendre à utiliser l'IA et la plupart sont gratuites. Donc on peut apprendre à développer des applications sans coder, à construire notre propre petit modèle de langage et même à fine-tuner Gemini. On peut aussi filtrer par niveau, par langue, et obtenir des certifications. Pour accéder à tout ça, il suffit d'aller sur ce lien et si cette astuce vous a plu
...
Sur le sujet **Alerte formations IA gratuites par Google avec Google Skills Il y a p**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
