---
title: "Gemini : demarrer en 5 minutes"
date: 2026-06-10
excerpt: "Ouvrir Gemini, poser une demande claire, ajouter un fichier si besoin, iterer."
type: tutorial
tags: [IA, Gemini, NotebookLM, Google]
og_image: ia-gemini-comment-utiliser-gemini-l-intelligence-artificielle-de-goo-1200x630.jpg
...
<figure class="schema-figure">
  <img src="/assets/images/blog/schemas/ia-gemini-start.svg" alt="Schema demarrage Gemini" class="schema-inline" width="640" />
  <figcaption>Ouvrir, prompt, fichiers, relancer.</figcaption>
</figure>
...
Comment utiliser Gemini l'intelligence artificielle de Goo
...
C'est un tutoriel pour savoir comment utiliser l'intelligence artificielle Gemini comme en assistant en direct. Vous avez juste à aller sur ce site et à vérifier à droite au niveau du modèle que vous êtes bien sur Gemini
...
Ensuite à gauche de la page tu peux cliquer sur Stream Realtime et là tu peux soit parler en direct avec Gemini, utiliser votre webcam pour lui montrer ce que tu veux ou bien partager votre écran avec. Et si vous choisissez de partager votre écran tu peux lui poser des questions en direct sur ce que vous êtes en train de faire. Alors pour le moment c'est pas parfait, surtout que c'est pas un modèle qui est capable de transformer de la voix en voix mais qui passe par une étape de texte donc les conversations sont beaucoup moins fluides que sur ChatGPT. Mais c'est quand même super cool à essayer et surtout c'est gratuit.
...
Sur le sujet **Comment utiliser Gemini l'intelligence artificielle de Goo**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
