---
title: "Comment garder le même personnage dans des vidéos IA"
date: 2026-05-11
excerpt: "Comment garder le même personnage dans plusieurs vidéos IA ?"
type: toolbox
tags: [IA, prompts, ChatGPT, Claude, prompt engineering]
og_image: ia-prompts-comment-garder-le-meme-personnage-dans-des-videos-ia-pour-1200x630.jpg
series: ia-prompts-serie
series_order: 10
---

# Comment garder le même personnage dans des vidéos IA

Des ressources et méthodes à garder sous le coude. Pas besoin de tout faire d'un coup.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-prompts-comment-garder-le-meme-personnage-dans-des-videos-ia-pour-banner.webp" alt="Illustration : Comment garder le même personnage dans des vidéos IA" class="schema-inline" width="720" loading="lazy" />
...
Comment garder le même personnage dans plusieurs vidéos IA ? Pour créer des histoires cohérentes et plus longues, parce qu'en général les outils sont limités à quelques secondes. C'est assez simple, il faut juste savoir comment faire. Pour ça on peut aller sur ce site. Ils…
### Des ressources et méthodes à garder sous le coude

Des ressources et méthodes à garder sous le coude.
### Étape 4

Comment garder le même personnage dans plusieurs vidéos IA ? Pour créer des histoires cohérentes et plus longues, parce qu'en général les outils sont limités à quelques secondes. C'est assez simple, il faut juste savoir comment faire. Pour ça on peut aller sur ce site. Ils ont des crédits gratuits et surtout ils ont plein de modèles différents, ce qui est très pratique. Donc on va dans images, et là je vais mettre mon premier prompt. Et en fait l'astuce c'est ici de récupérer la seed, qui est en fait le nombre qui servira de référence pour cette image.
### Étape 5

Ensuite on peut créer d'autres images, mais en faisant bien attention ici de toujours avoir la bonne seed.
### Étape 6

Ensuite il faudra transformer nos images en vidéo en cliquant ici. Et voilà par exemple le résultat. Pensez à vous abonner, je partage une astuce par jour sur l'IA.
...
Sur le sujet **Comment garder le même personnage dans des vidéos IA**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
