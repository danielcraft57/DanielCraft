---
title: "Les \"experts en IA\" vs les \"personnes qui s"
date: 2026-09-02
excerpt: "Vidéo rapide juste pour rappeler que savoir utiliser l'IA ne fait pas de nous des experts en IA. Du coup, merci pour le compliment, mais je peux absolument pas l'accepter parce que je suis pas du…"
type: checklist
tags: [IA, productivite, organisation]
og_image: ia-prod-les-experts-en-ia-vs-les-personnes-qui-s-1200x630.jpg
series: ia-productivite-serie
series_order: 4
---

# Les "experts en IA" vs les "personnes qui s

Tu peux traiter ça comme une liste d'actions à cocher.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-prod-les-experts-en-ia-vs-les-personnes-qui-s-banner.webp" alt="Illustration : Les "experts en IA" vs les "personnes qui s" class="schema-inline" width="720" loading="lazy" />
...
Vidéo rapide juste pour rappeler que savoir utiliser l'IA ne fait pas de nous des experts en IA.
...
Du coup, merci pour le compliment, mais je peux absolument pas l'accepter parce que je suis pas du tout une experte, dans le sens où j'ai jamais fait de doctorat en deep learning, en machine learning ou quoi.
...
Sur le sujet **Les "experts en IA" vs les "personnes qui s**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
