---
title: "Un homme vient de créer un Conseil des IA, avec un tutoriel pour fair"
date: 2026-06-08
excerpt: "Vous allez penser que c'est une blague alors que pas du tout. Pendant que tout le monde perd du temps à se demander qu'elle y a à choisir, ce mec sur Twitter a créé un conseil des IA."
type: tutorial
...
series_order: 3
---
# Un homme vient de créer un Conseil des IA, avec un tutoriel pour fair

On avance étape par étape. L'idée c'est que tu puisses le refaire sans revenir dix fois dans la video d'origine.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-gemini-un-homme-vient-de-creer-un-conseil-des-ia-avec-un-tutoriel-pour-fair-banner.webp" alt="Illustration : Un homme vient de créer un Conseil des IA, avec un tutoriel pour fair" class="schema-inline" width="720" loading="lazy" />
...
### Vous allez penser que c'est une blague alors que pas du tout

Vous allez penser que c'est une blague alors que pas du tout. Pendant que tout le monde perd du temps à se demander qu'elle y a à choisir, ce mec sur Twitter a créé un conseil des IA. Donc il utilise les
...
Puis il les fait discuter ensemble pour qu'il vote pour la meilleure réponse à chaque fois qu'il pose une question. Mais le plus cool c'est qu'il a tout partagé gratuitement pour qu'on puisse faire la même chose. Donc par exemple si je demande qui sera le prochain président français, étape
...
Sur le sujet **Un homme vient de créer un Conseil des IA, avec un tutoriel pour fair**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
