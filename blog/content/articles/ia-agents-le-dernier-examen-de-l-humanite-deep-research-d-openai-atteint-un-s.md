---
title: "Le dernier examen de l’Humanité : Deep Research d’OpenAI atteint un s"
date: 2026-06-28
excerpt: "Les IA sont de plus en plus puissantes. Concrètement, en deux ans, on est passé d'un collègue moyen à l'équivalent d'Einstein sur notre ordinateur."
type: guide
tags: [IA, agents, automatisation, OpenAI]
og_image: ia-agents-le-dernier-examen-de-l-humanite-deep-research-d-openai-atteint-un-s-1200x630.jpg
series: ia-agents-serie
series_order: 11
---
# Le dernier examen de l’Humanité : Deep Research d’OpenAI atteint un s

Voici le cœur du sujet, organisé pour que tu puisses t'en servir demain matin sans te perdre.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-agents-le-dernier-examen-de-l-humanite-deep-research-d-openai-atteint-un-s-banner.webp" alt="Illustration : Le dernier examen de l’Humanité : Deep Research d’OpenAI atteint un s" class="schema-inline" width="720" loading="lazy" />
...
### Les IA sont de plus en plus puissantes

Les IA sont de plus en plus puissantes. Concrètement, en deux ans, on est passé d'un collègue moyen à l'équivalent d'Einstein sur notre ordinateur. Et c'est tout pour nous, mais ça veut aussi dire que ça devient de plus en plus difficile d'évaluer l'intelligence des modèles,…
### Étape 4

Voici le cœur du sujet, organisé pour que tu puisses t'en servir demain matin.
### Les IA sont de plus en plus puissantes

Les IA sont de plus en plus puissantes. Concrètement, en deux ans, on est passé d'un collègue moyen à l'équivalent d'Einstein sur notre ordinateur. Et c'est tout pour nous, mais ça veut aussi dire que ça devient de plus en plus difficile d'évaluer l'intelligence des modèles, qui d'ailleurs se rapprochent tous dangereusement de la barre des
### 100%, qui rendrait l'évaluation complètement inutile

100%, qui rendrait l'évaluation complètement inutile. Donc pour parler à ça, il y a environ deux semaines, un groupe de
...
Sur le sujet **Le dernier examen de l’Humanité : Deep Research d’OpenAI atteint un s**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
