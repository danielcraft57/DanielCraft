---
title: "ChatGPT : un modele de prompt qui marche vraiment"
date: 2026-05-14
excerpt: "Role, contexte, tache, format, exemple : un canevas simple pour de meilleures reponses."
type: tutorial
tags: [IA, ChatGPT, productivite, astuces]
og_image: ia-chatgpt-comment-utiliser-chatgpt-5-template-a-suivre-pour-creer-de-meilleur-1200x630.jpg
...
<figure class="schema-figure">
  <img src="/assets/images/blog/schemas/ia-chatgpt-prompt.svg" alt="Schema d'un bon prompt" class="schema-inline" width="640" />
  <figcaption>Role, contexte, tache, format, exemple.</figcaption>
</figure>
...
Comment utiliser ChatGPT 5 : template à suivre pour créer de meilleur
...
Comment utiliser ChatGPT 5 : template à suivre pour créer de meilleur
### Ok, apparemment personne ne sait utiliser ChatGPT
...
Ok, apparemment personne ne sait utiliser ChatGPT
### 5 correctement, donc voici la bonne méthode selon OpenAI en

5 correctement, donc voici la bonne méthode selon OpenAI en
### Étape 6

6 étapes. Pour commencer, il faut donner un rôle à l'IA, ensuite il faut lui détailler la tâche qu'on veut qu'elle fasse pour nous, puis le contexte nécessaire pour réaliser cette tâche, les différentes étapes à suivre pour le raisonnement, format que l'on veut pour la réponse, et terminer par les conditions nécessaires avant la fin de la tâche. J'ai trouvé ça sur ce compte Instagram et il donne un exemple avec la template, donc je te mets ça en description et ce sera aussi disponible ici dans ma biographie.
...
Sur le sujet **Comment utiliser ChatGPT 5 : template à suivre pour créer de meilleur**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
