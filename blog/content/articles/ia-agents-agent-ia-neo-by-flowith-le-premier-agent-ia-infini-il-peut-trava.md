---
title: "Agent IA Neo by Flowith, le premier agent IA \"infini\" : il peut trava"
date: 2026-06-22
excerpt: "Ok, la Chine continue de nous impressionner avec un tout nouvel agent IA. Il s'appelle Neo par Flowis et pour la toute première fois, on a un agent IA infini qui peut travailler 24 heures sur 24."
type: guide
tags: [IA, agents, automatisation, OpenAI]
og_image: ia-agents-agent-ia-neo-by-flowith-le-premier-agent-ia-infini-il-peut-trava-1200x630.jpg
series: ia-agents-serie
series_order: 5
---
# Agent IA Neo by Flowith, le premier agent IA "infini" : il peut trava

Voici le cœur du sujet, organisé pour que tu puisses t'en servir demain matin sans te perdre.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-agents-agent-ia-neo-by-flowith-le-premier-agent-ia-infini-il-peut-trava-banner.webp" alt="Illustration : Agent IA Neo by Flowith, le premier agent IA "infini" : il peut trava" class="schema-inline" width="720" loading="lazy" />
...
Ok, la Chine continue de nous impressionner avec un tout nouvel agent IA. Il s'appelle Neo par Flowis et pour la toute première fois, on a un agent IA infini qui peut travailler
### Étape 4
...
24. Concrètement, l'agent peut exécuter des tâches pendant plusieurs heures dans le cloud même si notre ordinateur est éteint. Il peut construire un site e-commerce complet avec des descriptions de produits, des images et même une fonctionnalité de paiement. Et on peut suivre toutes les étapes de l'agent dans la partie Canva. On peut aussi lui envoyer une vidéo YouTube comme ici ce cours d'algèbre du MIT et l'agent peut créer un site interactif en reprenant le contenu de la vidéo. L'avantage, c'est qu'on peut l'essayer gratuitement et si tu veux des crédits en plus, j'ai aussi un code promo mais vous n'êtes pas du tout obligé d'utiliser. Si l'intelligence artificielle vous intéresse
...
Sur le sujet **Agent IA Neo by Flowith, le premier agent IA "infini" : il peut trava**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
