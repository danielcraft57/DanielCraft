...
<figure class="schema-figure">
  <img src="/assets/images/blog/schemas/ia-chatgpt-photo.svg" alt="Schema photo repas ChatGPT" class="schema-inline" width="640" />
  <figcaption>Utile pour approximer, pas pour certifier.</figcaption>
</figure>
...
Astuce ChatGPT pour tous les gomuscu et autres sportifs qui veulent c
...
Astuce pour toutes les personnes qui font du sport ou juste qui font attention à leur alimentation, est-ce que vous saviez que si vous envoyez une photo de votre repas à ChatGPT, il peut vous dire combien il y a de calories dedans et quels sont les macronutriments ?
...
Bon, si vous êtes en train de préparer une compétition de bodybuilding, c'est peut-être pas la meilleure méthode parce que l'IA peut toujours se tromper, mais pour avoir fait le test plusieurs fois, les résultats sont quand même assez bons.
...
Sur le sujet **Astuce ChatGPT pour tous les gomuscu et autres sportifs qui veulent c**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
