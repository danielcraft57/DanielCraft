---
title: "Nouveaux plugins Claude pour la finance Les plugins prennent 5 min"
date: 2026-06-02
excerpt: "Anthropic vient de sortir 10 niveaux plugins pour la finance, voici les trois qui peuvent vraiment aider les petits investisseurs."
type: tutorial
...
series_order: 9
---
# Nouveaux plugins Claude pour la finance Les plugins prennent 5 min

On avance étape par étape. L'idée c'est que tu puisses le refaire sans revenir dix fois dans la video d'origine.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-claude-nouveaux-plugins-claude-pour-la-finance-les-plugins-prennent-5-min-banner.webp" alt="Illustration : Nouveaux plugins Claude pour la finance Les plugins prennent 5 min" class="schema-inline" width="720" loading="lazy" />
...
Anthropic vient de sortir 10 niveaux plugins pour la finance, voici les trois qui peuvent vraiment aider les petits investisseurs.
...
Le premier analyse les résultats financiers d'une entreprise, on peut lui envoyer un rapport pour que l'IA nous explique clairement ce qui a été dit et qu'on puisse prendre de meilleures décisions.
...
Sur le sujet **Nouveaux plugins Claude pour la finance Les plugins prennent 5 min**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
