---
title: "Comment créer le mock up d'une application ou d'un site we"
date: 2026-07-03
excerpt: "Vous ne le saviez pas, mais on peut le faire avec IA partie 1. Si vous allez sur ChatGPT4 et que vous lui demandez la maquette d'une application, vous pouvez ensuite enregistrer l'image, la coller…"
type: tutorial
tags: [IA, images, design, visuels]
og_image: ia-images-comment-creer-le-mock-up-d-une-application-ou-d-un-site-we-1200x630.jpg
series: ia-images-serie
series_order: 4
---

# Comment créer le mock up d'une application ou d'un site we

On avance étape par étape. L'idée c'est que tu puisses le refaire sans revenir dix fois dans la video d'origine.

<figure>
  <img src="../../assets/images/blog/illustrations/ia-images-comment-creer-le-mock-up-d-une-application-ou-d-un-site-we-banner.webp" alt="Illustration : Comment créer le mock up d'une application ou d'un site we" class="schema-inline" width="720" loading="lazy" />
...
### Vous ne le saviez pas, mais on peut le faire avec IA partie
...
1. Si vous allez sur ChatGPT4 et que vous lui demandez la maquette d'une application, tu peux ensuite enregistrer l'image, la coller sur Figma, puis ensuite utiliser un plugin, attendre que l'image soit scannée, et tout votre design deviendra complètement éditable.
...
Sur le sujet **Comment créer le mock up d'une application ou d'un site we**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
