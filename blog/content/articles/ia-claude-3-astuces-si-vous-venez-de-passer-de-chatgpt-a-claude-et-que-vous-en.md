---
title: "Passer de ChatGPT a Claude : 3 reflexes utiles"
date: 2026-05-31
excerpt: "Garde tes bons reflexes de prompt, adapte le reste a Claude."
type: tutorial
tags: [IA, Claude, Anthropic, productivite]
og_image: ia-claude-3-astuces-si-vous-venez-de-passer-de-chatgpt-a-claude-et-que-vous-en-1200x630.jpg
...
<figure class="schema-figure">
  <img src="/assets/images/blog/schemas/ia-claude-switch.svg" alt="Schema transition ChatGPT vers Claude" class="schema-inline" width="640" />
  <figcaption>Garder le bon, adapter le reste.</figcaption>
</figure>
...
3 astuces si vous venez de passer de ChatGPT à Claude et que vous en
...
Si vous venez de passer de ChatGPT à Claude et que vous avez déjà reçu ce message, voici trois astuces à mettre en place avant de passer à l'abonnement supérieur. N°
...
Si vous venez de passer de ChatGPT à Claude et que vous avez déjà reçu ce message, voici trois astuces à mettre en place avant de passer à l'abonnement supérieur. N°
### 1, faites attention aux modèles que vous choisissez

1, faites attention aux modèles que vous choisissez. Chaque modèle consomme plus ou moins de tokens selon sa puissance. Pour une tâche simple, tu peux utiliser Haiku qui est économe et rapide. Pour quelque chose de plus complexe, passez sur Opus. Et pour en juste milieu, sonner sera très bien. N°
...
Sur le sujet **3 astuces si vous venez de passer de ChatGPT à Claude et que vous en**, le plus gros gain vient souvent du premier test serieux : tu vois tout de suite ce qui bloque, et tu ajustes.
