#!/usr/bin/env python3
"""Build unique vitrine demo pages (19 slugs). Run from repo root."""
...
def emit(slug, layout, fw, title, desc, body, css, extra=""):
    html = f"""<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="utf-8">
...
# Slug builders imported from data module
from build_vitrine_demos_data import BUILDERS  # noqa: E402

if __name__ == "__main__":
    for fn in BUILDERS:
        fn(emit)
    print(f"Built {len(BUILDERS)} demos.")
