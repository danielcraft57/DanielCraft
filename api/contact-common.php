...
{
    if (!function_exists('prestations_find_by_service_slug')) {
        require_once __DIR__ . '/prestations-common.php';
    }
    $catalogItem = prestations_find_by_service_slug($slug);
    if ($catalogItem !== null) {
        $title = (string) ($catalogItem['title'] ?? $slug);
        $price = (int) ($catalogItem['price_eur'] ?? 0);
        if ($price > 0) {
            return $title . ' (' . $price . '€)';
        }
        return $title;
    ...
    static $map = [
        'pack_vitrine_essentiel' => 'Site vitrine essentiel (390€)',
        'pack_vitrine' => 'Site vitrine professionnel (590€)',
        'pack_identite' => 'Identité & visibilité multi-supports (890€)',
        'pack_seo_complet' => 'SEO Google + ChatGPT — pack (690€)',
        ...
        'seo_chatgpt_490' => 'SEO ChatGPT / découvrabilité IA (449€)',
        'ia_faq_site' => 'Assistant IA FAQ site web (990€)',
        'ia_support_client' => 'Assistant IA support client / email (1090€)',
        'ia_contenu_web' => 'Générateur de contenus web par IA (490€)',
        'ia_redaction_pro' => 'Assistant IA rédaction commerciale (449€)',
        'ia_analyse_donnees' => 'Analyse de données avec IA (1290€)',
        'ia_chatbot_ecom' => 'Chatbot IA e-commerce (1490€)',
        'ia_automatisation' => 'Automatisation de tâches avec IA (1090€)',
        'ia_abo_mensuel' => 'Maintenance mensuelle assistant IA (69€/mois)',
        'ia_evolution' => 'Évolution fonctionnalités IA (dès 330€)',
        'ia_audit' => 'Audit utilisation IA (349€)',
        'tech_conseil_archi' => 'Conseil technique / architecture (349€)',
        'tech_integration_crm' => 'Intégration CRM ou outil métier (dès 299€)',
        'tech_migration_donnees' => 'Migration de données (349€)',
        'tech_api_webhook' => 'Intégration API / webhook (dès 179€)',
        'tech_perf_rapport' => 'Rapport de performances (129€)',
        'eco_audit_site' => 'Audit éco-numérique du site (149€)',
        'eco_medias_optimize' => 'Allègement images & vidéos (199€)',
        'eco_perf_fix' => 'Site allégé — corrections sobriété (dès 329€)',
        'pack_vitrine_eco' => 'Site vitrine éco-conçu (590€)',
        'eco_page_rse' => 'Page engagement numérique (89€)',
        'eco_monitor_mensuel' => 'Veille sobriété mensuelle (35€/mois)',
        'eco_formation_2h' => 'Atelier éco-conception web (129€ · 2 h)',
        'site_page_supp' => 'Page supplémentaire site vitrine (59€/page)',
        'site_form_avance' => 'Formulaire avancé / intégration (99€)',
        'site_refonte_visuelle' => 'Refonte visuelle légère (349€)',
        'site_maj_contenu_5h' => 'Mise à jour contenu — pack 5h (249€)',
        'maint_site_mensuel' => 'Maintenance site mensuelle (49€/mois)',
        'maint_hebergement' => 'Hébergement + domaine (89€/an)',
        'maint_backup' => 'Backup & sécurisation (119€)',
        'maint_ssl' => 'SSL + configuration (49€)',
        'maint_support_abo' => 'Support / abonnement (29€/mois)',
        'maint_depannage_2h' => 'Dépannage forfait 2h (139€)',
        'maint_accompagnement_h' => 'Accompagnement technique à l\'heure (65€/h)',
        'maint_support_prio_h' => 'Support prioritaire à l\'heure (75€/h)',
