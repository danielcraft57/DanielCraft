...
function contact_service_label(string $slug): string
{
    static $map = [
        ...
        'eco_medias_optimize' => 'Allègement images & vidéos (190€)',
        'eco_perf_fix' => 'Site allégé — corrections sobriété (dès 290€)',
        'pack_vitrine_eco' => 'Site vitrine éco-conçu (490€)',
        'eco_page_rse' => 'Page engagement numérique (85€)',
        'eco_monitor_mensuel' => 'Veille sobriété mensuelle (29€/mois)',
        'eco_formation_2h' => 'Atelier éco-conception web (120€ · 2 h)',
