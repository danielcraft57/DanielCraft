# Prompts pour les images Open Graph des articles GEO

Chaque article du blog peut avoir une image OG dédiée. Place les images dans `assets/images/og/` avec le nom indiqué.
...
## geo-guide-complet-1200x630.jpg
