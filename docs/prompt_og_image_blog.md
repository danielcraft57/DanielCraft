# Prompt pour l'image Open Graph du blog DanielCraft

Image utilisee pour le partage des articles du blog : `assets/images/og/blog-1200x630.jpg`

**Important : tous les textes visibles doivent être en français.**
...
```
Genere une image Open Graph (1200x630px) pour le blog d'un developpeur freelance, theme : GEO, SEO et IA.

Contenu :
- Titre : "Blog DanielCraft" (police Inter, gras, gris fonce)
- Sous-titre : "Articles - GEO, SEO, IA" (plus petit, gris)
- Elements visuels abstraits : icone IA (cerveau ou reseau), icone recherche/SEO (loupe), symbole de citation ou bulle de dialogue
- Schema minimaliste : flux "Contenu -> Moteur IA -> Citation" represente par des fleches ou blocs
- Couleur principale : rouge #dc2626 en accent (badge, ligne, bordure)
...
Une fois generee, placer l'image dans :
```
DanielCraftFr/assets/images/og/blog-1200x630.jpg
```
