/**
 * Section #vitrines (accueil) : filtres secteur + défilement auto des
 * captures au survol de la carte (ascenseurs masqués en CSS).
 */
(function () {
  const root = document.getElementById('vitrines');
  if (!root) return;
