#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre E-commerce - Trouver des clients et genere un PDF telechargeable."""
...
BOOK_CSS = get_book_css("ecom_clients") + """
.illus.illus-scene {
...
OUT_PDF = ROOT.parent.parent / "pdf" / "ecommerce-trouver-clients.pdf"

CHAPTER_FILES = [
    "01-cest-quoi.md",
    "02-offre-cible.md",
    "03-proposition-valeur.md",
    "04-seo-contenu.md",
    "05-google-shopping.md",
    "06-meta-ads.md",
    "07-tiktok-social.md",
    "08-influence.md",
    "09-email-sms.md",
    "10-marketplace.md",
    "11-communaute-referral.md",
    "12-mesure-cac-ltv.md",
    "13-budget-tests.md",
    "14-mini-projet.md",
    "15-retenir.md",
    "16-atelier-canal.md",
    "17-atelier-creative.md",
    "18-atelier-funnel.md",
    "19-tendances-2026.md",
    "20-quiz.md",
    "21-bravo.md",
]
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("trouver-clients-carte.png", "Acquisition = trafic x conversion x retention."),
    ],
    2: [
        ("trouver-clients-offre-cible.png", "Pour qui, quoi, pourquoi - avant les canaux."),
        ("trouver-clients-scene-offre.png", "Exemple : clarifier l'offre avant de publier."),
    ],
    3: [
        ("trouver-clients-offre.png", "Proposition de valeur : une phrase nette."),
    ],
    4: [
        ("trouver-clients-seo.png", "SEO : intention, pages utiles, liens."),
    ],
    5: [
        ("trouver-clients-shopping.png", "Shopping : flux propre, intention d'achat."),
    ],
    6: [
        ("trouver-clients-pubs.png", "Meta : creatives natives, retargeting."),
        ("trouver-clients-scene-pub.png", "Exemple : creative UGC dans le feed."),
    ],
    7: [
        ("trouver-clients-tiktok.png", "TikTok : hook, demo, social commerce."),
    ],
    8: [
        ("trouver-clients-influence.png", "Influence : micro, brief, tracking."),
    ],
    9: [
        ("trouver-clients-email.png", "Email / SMS : canaux owned."),
    ],
    10: [
        ("trouver-clients-marketplace.png", "Marketplaces : trafic locatif, marge."),
    ],
    11: [
        ("trouver-clients-referral.png", "Communaute et parrainage."),
    ],
    12: [
        ("trouver-clients-cac-ltv.png", "CAC, LTV et ratio ~3:1."),
        ("trouver-clients-scene-mesure.png", "Exemple : lire CAC et LTV sur un tableau."),
    ],
    13: [
        ("trouver-clients-budget.png", "Tests bornes : hypothese, seuils, revue."),
    ],
    14: [
        ("trouver-clients-projet.png", "Plan 90 jours : concentrer et mesurer."),
    ],
    15: [
        ("trouver-clients-retenir.png", "Carte acquisition : systeme, pas hack."),
    ],
    16: [
        ("trouver-clients-atelier-canal.png", "Atelier : score, cadre, pre-flight."),
    ],
    17: [
        ("trouver-clients-atelier-creative.png", "Atelier : hook, demo, CTA."),
    ],
    18: [
        ("trouver-clients-atelier-funnel.png", "Funnel : decouverte a retention."),
    ],
    19: [
        ("trouver-clients-tendances.png", "2026 : CAC, owned, preuves."),
    ],
    20: [
        ("trouver-clients-quiz.png", "Verifier sans inventer."),
    ],
    21: [
        ("trouver-clients-felicitations.png", "Bravo. Tu as une carte, pas un hack."),
    ],
}

COVER_IMAGE = "trouver-clients-couverture.png"

BOOK_TITLE = "E-commerce - Trouver des clients"
BOOK_SHORT = "E-commerce - Trouver des clients"
BOOK_LEAD = "Acquisition 2026 : offre, SEO, Shopping, Meta, TikTok, email/SMS, CAC/LTV ~3:1."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation e-commerce acquisition clients France 2026"
BOOK_KEYWORDS = "e-commerce, acquisition, SEO, Meta Ads, TikTok, Google Shopping, email, CAC, LTV, formation"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation e-commerce</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre E-commerce Trouver des clients + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "ecommerce-trouver-clients-eco.pdf" if args.eco else "ecommerce-trouver-clients.pdf"
    )
