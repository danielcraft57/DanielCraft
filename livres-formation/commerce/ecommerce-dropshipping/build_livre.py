#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre E-commerce - Dropshipping et genere un PDF telechargeable."""
...
BOOK_CSS = get_book_css("ecom_drop") + """
.illus.illus-scene {
...
CHAPTER_FILES = [
    ...
    "05-niche.md",
    "06-fournisseurs.md",
    "07-boutique-legale.md",
    "08-logistique-delais.md",
    "09-pubs-couts.md",
    "10-sav-retours.md",
    "11-marque-vs-arbitrage.md",
    "12-mini-projet.md",
    "13-retenir.md",
    "14-atelier-niche.md",
    "15-atelier-fournisseurs.md",
    "16-atelier-lancement.md",
    "17-pod.md",
    "18-risques-juridiques.md",
    "19-arreter-pivoter.md",
    "20-quiz.md",
    "21-bravo.md",
]
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("ecommerce-dropshipping-carte.png", "2026 : opportuniste sature, serieux possible."),
    ],
    2: [
        ("ecommerce-dropshipping-definition.png", "Client paie, fournisseur envoie, tu restes vendeur."),
    ],
    3: [
        ("ecommerce-dropshipping-mythes.png", "Zero risque et jackpot TikTok : mythes."),
    ],
    4: [
        ("ecommerce-dropshipping-marges.png", "Marge nette apres CAC, pas reve TikTok."),
    ],
    5: [
        ("ecommerce-dropshipping-niche.png", "Pour qui, resultat, delai tenable."),
    ],
    6: [
        ("ecommerce-dropshipping-fournisseurs.png", "UE vs Chine : delai, qualite, conformite."),
        ("ecom-drop-scene-fournisseur.png", "Exemple : challenger un fournisseur."),
    ],
    7: [
        ("ecommerce-dropshipping-legal.png", "Legal UE : TVA, GPSR, SAV."),
        ("ecom-drop-scene-legal.png", "Exemple : socle legal avant les pubs."),
    ],
    8: [
        ("ecommerce-dropshipping-logistique.png", "Promesse affichee = promesse tenue."),
    ],
    9: [
        ("ecommerce-dropshipping-pubs.png", "CAC 2026 : plafond et kill switch."),
        ("ecom-drop-scene-budget.png", "Exemple : protocole budget avant le clic."),
    ],
    10: [
        ("ecommerce-dropshipping-sav.png", "SAV, retours, chargebacks."),
    ],
    11: [
        ("ecommerce-dropshipping-marque.png", "Marque vs arbitrage catalogue."),
    ],
    12: [
        ("ecommerce-dropshipping-projet.png", "Lancer prudent : tester sans se cramer."),
    ],
    13: [
        ("ecommerce-dropshipping-retenir.png", "Carte dropshipping serieux."),
    ],
    14: [
        ("ecommerce-dropshipping-atelier-niche.png", "Atelier : cadrer la niche."),
    ],
    15: [
        ("ecommerce-dropshipping-atelier-fournisseurs.png", "Atelier : selectionner, challenger."),
    ],
    16: [
        ("ecommerce-dropshipping-atelier-lancement.png", "Atelier : plan de lancement."),
    ],
    17: [
        ("ecommerce-dropshipping-pod.png", "POD : design et fabrication a la commande."),
    ],
    18: [
        ("ecommerce-dropshipping-juridique.png", "Risques produit, pub, donnees."),
    ],
    19: [
        ("ecommerce-dropshipping-pivoter.png", "Arreter ou pivoter sans drama."),
    ],
    20: [
        ("ecommerce-dropshipping-quiz.png", "Verifier sans inventer."),
    ],
    21: [
        ("ecommerce-dropshipping-felicitations.png", "Bravo. Tu vois le drop sans filtre."),
    ],
}

COVER_IMAGE = "ecommerce-dropshipping-couverture.png"

BOOK_TITLE = "E-commerce - Dropshipping"
BOOK_SHORT = "E-commerce - Dropshipping"
BOOK_LEAD = "Realite 2026 FR/EU : niche, fournisseurs UE, delais, marge nette, conformite."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation e-commerce dropshipping France Europe 2026"
BOOK_KEYWORDS = "dropshipping, e-commerce, fournisseurs UE, TVA, SAV, marge, formation"
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre E-commerce Dropshipping + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
