#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Commerce - Vente avancee et genere un PDF telechargeable."""
...
BOOK_CSS = get_book_css("commerce2") + """
.illus.illus-scene {
...
OUT_PDF = ROOT.parent.parent / "pdf" / "vente-avancee.pdf"
...
CHAPTER_FILES = [
    ...
    "03-qualification.md",
    "04-decouverte.md",
    "05-proposition-valeur.md",
    "06-objections-dures.md",
    "07-negociation.md",
    "08-closing.md",
    "09-suivi-relance.md",
    "10-crm-simple.md",
    ...
    "12-mini-projet.md",
    "13-retenir.md",
    "14-atelier-pipeline.md",
    "15-atelier-script.md",
    "16-atelier-negociation.md",
    "17-vente-equipe.md",
    "18-indicateurs.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("com2-carte.png", "Apres les bases : pipeline, valeur, objections, closing."),
    ],
    2: [
        ("com2-pipeline.png", "Le pipeline : voir ou en est chaque prospect."),
        ("com2-scene-pipeline.png", "Exemple : etapes visibles du parcours."),
    ],
    3: [
        ("com2-qualification.png", "Besoin, budget, decision : qualifier vite."),
    ],
    4: [
        ("com2-decouverte.png", "Decouvrir avant de pitcher."),
    ],
    5: [
        ("com2-valeur.png", "Pour qui, quel resultat, pourquoi toi."),
    ],
    6: [
        ("com2-objections.png", "Objections dures : ecouter, clarifier, repondre."),
    ],
    7: [
        ("com2-negociation.png", "Negocier : echanger, pas capituler."),
        ("com2-scene-nego.png", "Exemple : un echange calme autour de la table."),
    ],
    8: [
        ("com2-closing.png", "Demander la decision clairement."),
        ("com2-scene-closing.png", "Exemple : demander un oui clair."),
    ],
    9: [
        ("com2-suivi.png", "Relancer pour aider, pas harceler."),
    ],
    10: [
        ("com2-crm.png", "Qui, ou on en est, prochaine action."),
    ],
    11: [
        ("com2-ethics.png", "Promesses tenables, respect client."),
    ],
    12: [
        ("com2-projet.png", "Mini-projet : une vente de bout en bout."),
    ],
    13: [
        ("com2-retenir.png", "Carte vente avancee."),
    ],
    14: [
        ("com2-atelier-pipeline.png", "Liste, etapes, actions, revue."),
    ],
    15: [
        ("com2-atelier-script.png", "Ouverture, questions, transition."),
    ],
    16: [
        ("com2-atelier-nego.png", "Ce que tu cedes / ce que tu gagnes."),
    ],
    17: [
        ("com2-equipe.png", "Roles, passation, suivi commun."),
    ],
    18: [
        ("com2-indicateurs.png", "Closing, cycle, taille de deal."),
    ],
    19: [
        ("com2-pratiques.png", "Preparer, ecouter, tenir parole."),
    ],
    20: [
        ("com2-quiz.png", "Verifier sans inventer."),
    ],
    21: [
        ("com2-felicitations.png", "Bravo. Tu sais vendre proprement et regulierement."),
    ],
}

COVER_IMAGE = "com2-couverture.png"

BOOK_TITLE = "Commerce - Vente avancee"
BOOK_SHORT = "Vente avancee"
BOOK_LEAD = "Pipeline, valeur, objections dures, negociation et closing : vendre sans bruler les ponts."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation commerce vente intermediaire"
BOOK_KEYWORDS = "vente, commerce, pipeline, negociation, closing, CRM, formation"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation commerce - vente</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre Commerce Vente avancee + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "vente-avancee-eco.pdf" if args.eco else "vente-avancee.pdf"
    )
