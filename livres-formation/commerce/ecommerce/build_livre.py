#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre E-commerce et genere un PDF telechargeable."""
...
BOOK_CSS = get_book_css("ecommerce")

ROOT = Path(__file__).resolve().parent
CHAPITRES = ROOT / "chapitres"
OUT_HTML = ROOT / "livre.html"
OUT_PDF = ROOT.parent.parent / "pdf" / "ecommerce-les-bases.pdf"

CHAPTER_FILES = [
    "01-cest-quoi.md",
    "02-boutique-marketplace.md",
    "03-trouver-clients.md",
    "04-seo-contenu.md",
    "05-pubs.md",
    "06-social-commerce.md",
    "07-email-confiance.md",
    "08-dropshipping.md",
    "09-dropshipping-realite.md",
    "10-fournisseurs.md",
    "11-logistique.md",
    "12-conversion.md",
    "13-tendances.md",
    ...
    "16-pod-marque.md",
    "17-atelier-niche.md",
    "18-atelier-acquisition.md",
    "19-atelier-offre-ligne.md",
    "20-quiz.md",
    "21-bravo.md",
]
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("ecommerce-idee.png", "Vendre en ligne, c'est une boutique qui ne ferme pas a 19h."),
    ],
    2: [
        ("ecommerce-boutique.png", "Marketplace = trafic deja la. Boutique = ta marque a construire."),
    ],
    3: [
        ("ecommerce-clients.png", "Organique, pub, relation : trois chemins vers le client."),
    ],
    6: [
        ("ecommerce-social.png", "Social commerce : on achete la ou l'on scrolle."),
    ],
    8: [
        ("ecommerce-dropshipping.png", "Dropshipping : tu vends, le fournisseur envoie."),
    ],
    12: [
        ("ecommerce-conversion.png", "Voir, comprendre, croire, payer : moins de friction."),
    ],
    13: [
        ("ecommerce-tendances.png", "IA, social, livraison, marge : les tendances 2026."),
    ],
    21: [
        ("ecommerce-felicitations.png", "Bravo. Tu as une boussole pour vendre en ligne."),
    ],
}

COVER_IMAGE = "ecommerce-couverture.png"

BOOK_TITLE = "E-commerce - Les bases"
BOOK_SHORT = "E-commerce"
BOOK_LEAD = "Trouver des clients, comprendre le dropshipping, et suivre les tendances sans se faire avoir."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant e-commerce"
BOOK_KEYWORDS = "e-commerce, dropshipping, clients, social commerce, formation, debutant"
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre E-commerce + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "ecommerce-les-bases-eco.pdf" if args.eco else "ecommerce-les-bases.pdf"
    )
