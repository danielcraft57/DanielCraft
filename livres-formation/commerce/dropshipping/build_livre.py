...
CHAPTER_FILES = [
    "01-cest-quoi.md",
    "02-mythes-2026.md",
    "03-marges-reelles.md",
    "04-choix-niche.md",
    "05-fournisseurs-eu.md",
    "06-echantillons.md",
    "07-boutique-offre.md",
    "08-logistique-delais.md",
    "09-sav-retours.md",
    "10-pubs-tests.md",
    "11-conformite-tva.md",
    "12-qualite-marque.md",
    "13-hybride-stock.md",
    "14-mini-projet.md",
    "15-retenir.md",
    "16-atelier-fournisseur.md",
    "17-atelier-fiche.md",
    "18-atelier-budget-pub.md",
    "19-pieges.md",
    "20-quiz.md",
    "21-bravo.md",
]
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("drop-carte.png", "Offre, delai, marge nette : le socle 2026."),
    ],
    2: [
        ("drop-mythes.png", "Zero risque est un mythe."),
    ],
    3: [
        ("drop-marges.png", "Marge nette apres CAC et SAV."),
    ],
    4: [
        ("drop-niche.png", "Pour qui, resultat, pourquoi toi."),
    ],
    5: [
        ("drop-fournisseurs.png", "UE : delai, qualite, support."),
    ],
    6: [
        ("drop-echantillons.png", "Tester avant de payer la pub."),
        ("drop-scene-echantillon.png", "Exemple : ouvrir et juger l'echantillon."),
    ],
    7: [
        ("drop-boutique.png", "Hero, fiche claire, delai vrai."),
        ("drop-scene-fiche.png", "Exemple : ecrire une fiche honnete."),
    ],
    8: [
        ("drop-logistique.png", "Ce que tu affiches, tu le tiens."),
    ],
    9: [
        ("drop-sav.png", "Tu restes le vendeur face au client."),
    ],
    10: [
        ("drop-pubs.png", "Un canal, plafond, kill switch."),
        ("drop-scene-budget.png", "Exemple : protocole budget avant le clic."),
    ],
    11: [
        ("drop-conformite.png", "Mentions, TVA, produit : minimum adulte."),
    ],
    12: [
        ("drop-marque.png", "Preference et promesse tenue."),
    ],
    13: [
        ("drop-hybride.png", "Stocker les heros apres preuve."),
    ],
    14: [
        ("drop-projet.png", "Test 30 jours : cadre, preuve, decision."),
    ],
    15: [
        ("drop-retenir.png", "Carte dropshipping serieux."),
    ],
    16: [
        ("drop-atelier-fournisseur.png", "Questions, tableau, verdict."),
    ],
    17: [
        ("drop-atelier-fiche.png", "Pour qui, delai, preuves, CTA."),
    ],
    18: [
        ("drop-atelier-budget.png", "CAC max, plafond, kill switch."),
    ],
    19: [
        ("drop-pieges.png", "Voyants rouge, orange, jaune."),
    ],
    20: [
        ("drop-quiz.png", "Verifier sans inventer."),
    ],
    21: [
        ("drop-felicitations.png", "Bravo. Tu vois le drop sans filtre."),
    ],
}

COVER_IMAGE = "drop-couverture.png"
