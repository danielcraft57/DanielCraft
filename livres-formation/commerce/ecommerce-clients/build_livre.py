#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre E-commerce - Trouver des clients (ecommerce-clients) et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "ecommerce-clients.pdf"
...
CHAPTER_FILES = [
    ...
    "05-seo.md",
    "06-contenu.md",
    "07-pubs-meta-tiktok.md",
    "08-google-intent.md",
    "09-email-retention.md",
    "10-social.md",
    "11-marketplace.md",
    "12-cac-ltv.md",
    "13-mini-projet.md",
    "14-retenir.md",
    "15-atelier-avatar.md",
    "16-atelier-funnel.md",
    "17-atelier-budget.md",
    "18-pieges-budget.md",
    "19-ethique-pubs.md",
    "20-quiz.md",
    "21-bravo.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("ecommerce-clients-carte.png", "Acquisition = trafic x conversion x retention."),
    ],
    2: [
        ("ecommerce-clients-mentalite.png", "Apprendre vite, concentrer le budget."),
    ],
    3: [
        ("ecommerce-clients-avatar.png", "Avatar utile : qui, besoin, decision."),
        ("ecom-clients-scene-avatar.png", "Exemple : construire un avatar operationnel."),
    ],
    4: [
        ("ecommerce-clients-offre.png", "Offre claire avant les canaux."),
    ],
    5: [
        ("ecommerce-clients-seo.png", "SEO : intention, pages, fiches."),
    ],
    6: [
        ("ecommerce-clients-contenu.png", "Contenu qui aide a acheter."),
    ],
    7: [
        ("ecommerce-clients-pubs.png", "Un canal, creatives natives."),
        ("ecom-clients-scene-pub.png", "Exemple : creative UGC dans le feed."),
    ],
    8: [
        ("ecommerce-clients-google.png", "Google : capturer l'intention."),
    ],
    9: [
        ("ecommerce-clients-email.png", "Email / SMS : canaux owned."),
    ],
    10: [
        ("ecommerce-clients-social.png", "Social : preuve et demande."),
    ],
    11: [
        ("ecommerce-clients-marketplace.png", "Marketplaces : trafic locatif."),
    ],
    12: [
        ("ecommerce-clients-cac-ltv.png", "CAC, LTV : verite des chiffres."),
        ("ecom-clients-scene-mesure.png", "Exemple : lire CAC et LTV sur un tableau."),
    ],
    13: [
        ("ecommerce-clients-projet.png", "Plan 90 jours : concentrer et mesurer."),
    ],
    14: [
        ("ecommerce-clients-retenir.png", "Carte acquisition : systeme, pas hack."),
    ],
    15: [
        ("ecommerce-clients-atelier-avatar.png", "Atelier : interviews, criteres."),
    ],
    16: [
        ("ecommerce-clients-atelier-funnel.png", "Funnel : trafic, conversion, retention."),
    ],
    17: [
        ("ecommerce-clients-atelier-budget.png", "Budget 30 j : plafond, revue."),
    ],
    18: [
        ("ecommerce-clients-pieges.png", "Fragmenter, vanity metrics."),
    ],
    19: [
        ("ecommerce-clients-ethique.png", "Promesses, consentement, respect."),
    ],
    20: [
        ("ecommerce-clients-quiz.png", "Verifier sans inventer."),
    ],
    21: [
        ("ecommerce-clients-felicitations.png", "Bravo. Tu as une carte, pas un hack."),
    ],
}

COVER_IMAGE = "ecommerce-clients-couverture.png"

BOOK_TITLE = "E-commerce - Trouver des clients"
BOOK_SHORT = "E-commerce - Trouver des clients"
BOOK_LEAD = "Acquisition 2026 : avatar, offre, SEO, pubs, email, CAC/LTV, plan 90 jours."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation e-commerce acquisition clients France 2026"
BOOK_KEYWORDS = "e-commerce, acquisition, SEO, Meta Ads, TikTok, email, CAC, LTV, formation"
...
def main() -> int:
    ...
    pdf_name = args.pdf_name or (
        "ecommerce-clients-eco.pdf" if args.eco else "ecommerce-clients.pdf"
    )
