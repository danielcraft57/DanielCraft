#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Methodologie Scrum et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "methodologie-scrum.pdf"
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("scrum-idee.png", "Scrum = sprints courts, inspection, adaptation."),
        ("scrum-scene-roles.png", "Exemple : Lea, Max et Sam clarifient PO, SM et Developers."),
    ],
    2: [
        ("scrum-equipe.png", "Une equipe Scrum : meme but, competences melangees."),
    ],
    3: [
        ("scrum-roles.png", "PO, Scrum Master, Developers : trois jobs clairs."),
    ],
    4: [
        ("scrum-artefacts.png", "Backlog produit, backlog de sprint, increment montrable."),
    ],
    5: [
        ("scrum-sprint.png", "Le Sprint : une boite a temps avec un debut et une fin."),
    ],
    6: [
        ("scrum-planning.png", "Sprint Planning : pourquoi, quoi, comment."),
    ],
    7: [
        ("scrum-daily.png", "Daily : 15 minutes pour synchroniser et lever les freins."),
        ("scrum-scene-daily.png", "Exemple : Max synchro en 12 minutes, un frein leve."),
    ],
    8: [
        ("scrum-review.png", "Sprint Review : montrer l'increment et ecouter."),
    ],
    9: [
        ("scrum-retro.png", "Retro : une action concrete pour le prochain sprint."),
    ],
    10: [
        ("scrum-ready-done.png", "Ready pour commencer, Done pour montrer."),
    ],
    11: [
        ("scrum-estimation.png", "Estimation relative : comparer, pas predire des dates magiques."),
    ],
    12: [
        ("scrum-sprint-goal.png", "Sprint Goal : une boussole pour le tour."),
    ],
    13: [
        ("scrum-anti-patterns.png", "Anti-patterns : daily report, zero demo, PO fantome."),
    ],
    14: [
        ("scrum-mini-projet.png", "Mini-projet : simuler un sprint de bout en bout."),
    ],
    15: [
        ("scrum-retenir.png", "Sprint, roles, montrer, Done, action de retro."),
    ],
    16: [
        ("scrum-tendances.png", "Cadre intact, outils sobres, preuves visibles."),
    ],
    17: [
        ("scrum-atelier-roles.png", "Atelier : clarifier qui decide, qui aide, qui livre."),
    ],
    18: [
        ("scrum-atelier-sprint.png", "Atelier : designer un sprint realiste."),
    ],
    19: [
        ("scrum-atelier-board.png", "Atelier : un board simple a quatre colonnes."),
        ("scrum-scene-board.png", "Exemple : Lea limite a une carte en cours."),
    ],
    20: [
        ("scrum-quiz.png", "Verifier ce que tu as compris, sans inventer."),
    ],
    21: [
        ("scrum-felicitations.png", "Bravo. Tu as le cadre pour demarrer un sprint."),
    ],
}

COVER_IMAGE = "scrum-couverture.png"

BOOK_TITLE = "Methodologie Scrum"
BOOK_SHORT = "Methodologie Scrum"
BOOK_LEAD = "Sprint, roles, artefacts et evenements : le cadre explique simplement."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant methodologie Scrum"
BOOK_KEYWORDS = "scrum, sprint, backlog, agile, formation"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation Scrum</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre Methodologie Scrum + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "methodologie-scrum-eco.pdf" if args.eco else "methodologie-scrum.pdf"
    )
