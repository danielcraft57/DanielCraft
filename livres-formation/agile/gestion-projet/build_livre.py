#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Gestion de projet agile et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "gestion-projet-agile.pdf"

CHAPTER_FILES = [
    "01-cest-quoi.md",
    "02-cascade-vs-iteratif.md",
    "03-valeurs.md",
    "04-equipe-roles.md",
    "05-backlog.md",
    "06-iterations.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("agile-idee.png", "Agile = petits pas visibles + feedback tot."),
        ("agile-scene-livrable.png", "Exemple : Lea montre une page utile en 7 jours."),
    ],
    2: [
        ("agile-cascade.png", "Cascade : tout a la fin. Iteratif : livrer, ajuster, recommencer."),
    ],
    3: [
        ("agile-valeurs.png", "Clarte, collaboration, adaptation : des valeurs utiles au quotidien."),
    ],
    4: [
        ("agile-roles.png", "Qui decide, qui fait, qui facilite : roles simples et clairs."),
    ],
    5: [
        ("agile-backlog.png", "Une liste priorisee vaut mieux qu'une to-do geante."),
        ("agile-scene-backlog.png", "Exemple : Max trie cinq cartes avant d'ouvrir dix chantiers."),
    ],
    6: [
        ("agile-iterations.png", "Une iteration = un cycle court avec un bout livrable."),
    ],
    7: [
        ("agile-ceremonies.png", "Peu de reunions, utiles : planifier, synchroniser, montrer, apprendre."),
    ],
    8: [
        ("agile-dod.png", "Definition of Done : ce que 'termine' veut vraiment dire."),
    ],
    9: [
        ("agile-metriques.png", "Mesure ce qui aide a décider, pas ce qui flatte."),
    ],
    10: [
        ("agile-freins.png", "Freins classiques : priorites floues, trop gros, zero feedback."),
    ],
    11: [
        ("agile-hors-it.png", "Agile hors IT : commerce, asso, atelier - meme logique."),
    ],
    12: [
        ("agile-mini-projet.png", "Mini-projet 7 jours : un livrable visible et un retour."),
    ],
    13: [
        ("agile-retenir.png", "Priorite, cycle court, feedback, 'termine' clair."),
    ],
    14: [
        ("agile-tendances.png", "Hybride, outils simples, IA pour aller plus vite - avec controle."),
    ],
    15: [
        ("agile-atelier-carte.png", "Atelier : cartographier le projet en une page."),
    ],
    16: [
        ("agile-atelier-backlog.png", "Atelier : poser un premier backlog priorise."),
    ],
    17: [
        ("agile-atelier-retro.png", "Atelier : une premiere retro sans theatre."),
        ("agile-scene-retro.png", "Exemple : Sam anime bien / a ameliorer / prochaine etape."),
    ],
    18: [
        ("agile-pratiques.png", "Gestes qui tiennent : coupe, montre, ajuste."),
    ],
    19: [
        ("agile-pieges.png", "Pieges : agile theatre, zero priorite, reunions vides."),
    ],
    20: [
        ("agile-quiz.png", "Verifier ce que tu as compris, sans inventer."),
    ],
    21: [
        ("agile-felicitations.png", "Bravo. Tu as une boussole pour demarrer en agile."),
    ],
}

COVER_IMAGE = "agile-couverture.png"

BOOK_TITLE = "Gestion de projet agile"
BOOK_SHORT = "Gestion de projet agile"
BOOK_LEAD = "Petits pas, priorites claires, feedback tot : demarrer sans jargon de certif."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant gestion de projet agile"
BOOK_KEYWORDS = "agile, gestion de projet, backlog, iteration, scrum, formation, debutant"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation agile</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre Gestion de projet agile + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "gestion-projet-agile-eco.pdf" if args.eco else "gestion-projet-agile.pdf"
    )
