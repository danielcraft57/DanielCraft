#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Devenir Product Owner et genere un PDF telechargeable."""
...
BOOK_CSS = get_book_css("product_owner") + """
.illus.illus-scene {
...
OUT_PDF = ROOT.parent.parent / "pdf" / "devenir-product-owner.pdf"
...
CHAPTER_FILES = [
    ...
    "04-user-stories.md",
    "05-priorisation.md",
    "06-discovery-delivery.md",
    "07-roadmap.md",
    "08-dire-non.md",
    "09-avec-sm.md",
    "10-avec-dev.md",
    "11-metriques-valeur.md",
    "12-mini-projet.md",
    "13-retenir.md",
    "14-tendances.md",
    "15-atelier-vision.md",
    "16-atelier-backlog.md",
    "17-atelier-priorisation.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("po-idee.png", "Product Owner : vision, priorites, valeur livree tot."),
    ],
    2: [
        ("po-vision.png", "Vision produit : public, probleme, promesse en une page."),
        ("po-scene-vision.png", "Exemple : Lea ecrit la vision d'une vitrine locale."),
    ],
    3: [
        ("po-stakeholders.png", "Stakeholders : ecouter, traduire, decideur l'ordre."),
    ],
    4: [
        ("po-user-stories.png", "User stories + criteres d'acceptation concrets."),
    ],
    5: [
        ("po-priorisation.png", "Prioriser : valeur, risque, effort."),
        ("po-scene-priorisation.png", "Exemple : Lea et Max trient cinq cartes sans drame."),
    ],
    6: [
        ("po-discovery-delivery.png", "Discovery pour apprendre, Delivery pour livrer Done."),
    ],
    7: [
        ("po-roadmap.png", "Roadmap legere : maintenant / ensuite / plus tard."),
    ],
    8: [
        ("po-dire-non.png", "Dire non clairement : ecouter, expliquer, proposer."),
    ],
    9: [
        ("po-avec-sm.png", "Avec le Scrum Master : valeur d'un cote, cadre de l'autre."),
    ],
    10: [
        ("po-avec-dev.png", "Avec les Developers : Ready, disponibilite, feedback."),
    ],
    11: [
        ("po-metriques-valeur.png", "Metriques de valeur : usage, resultat, satisfaction."),
    ],
    12: [
        ("po-mini-projet.png", "Mini-projet : backlog d'une vitrine locale."),
    ],
    13: [
        ("po-retenir.png", "Vision, priorites, stories, dire non, mesurer."),
    ],
    14: [
        ("po-tendances.png", "Lots petits, data sobre, preuves terrain."),
    ],
    15: [
        ("po-atelier-vision.png", "Atelier : une vision lisible en 30 minutes."),
    ],
    16: [
        ("po-atelier-backlog.png", "Atelier : 8 items max, ordonnes, lot candidat."),
        ("po-scene-backlog.png", "Exemple : backlog vitrine pret pour le sprint."),
    ],
    17: [
        ("po-atelier-priorisation.png", "Atelier : matrice valeur x effort."),
    ],
    18: [
        ("po-pratiques.png", "Gestes qui tiennent : ordre, criteres, dispo, mesure."),
    ],
    19: [
        ("po-pieges.png", "Pieges : tout urgent, PO fantome, roadmap figee."),
    ],
    20: [
        ("po-quiz.png", "Verifier ce que tu as compris, sans inventer."),
    ],
    21: [
        ("po-felicitations.png", "Bravo. Tu peux porter un backlog utile demain."),
    ],
}

COVER_IMAGE = "po-couverture.png"

BOOK_TITLE = "Devenir Product Owner"
BOOK_SHORT = "Devenir Product Owner"
BOOK_LEAD = "Vision, priorites, stories et dire non : le role explique simplement."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant Product Owner"
BOOK_KEYWORDS = "product owner, backlog, priorisation, agile, formation"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation Product Owner</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre Devenir Product Owner + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "devenir-product-owner-eco.pdf" if args.eco else "devenir-product-owner.pdf"
    )
