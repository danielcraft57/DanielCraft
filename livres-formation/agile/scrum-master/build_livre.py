#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Devenir Scrum Master et genere un PDF telechargeable."""
...
BOOK_CSS = get_book_css("scrum_master") + """
.illus.illus-scene {
...
OUT_PDF = ROOT.parent.parent / "pdf" / "devenir-scrum-master.pdf"

CHAPTER_FILES = [
    "01-cest-quoi.md",
    "02-servant-leadership.md",
    "03-facilitation.md",
    "04-obstacles.md",
    "05-focus.md",
    "06-coaching-po.md",
    ...
    "13-retenir.md",
    "14-tendances.md",
    "15-atelier-facilitation.md",
    "16-atelier-freins.md",
    "17-atelier-coaching.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("sm-idee.png", "Scrum Master : cadre, freins, focus - sans jouer au chef."),
    ],
    2: [
        ("sm-servant.png", "Servant leadership : servir pour que l'equipe avance."),
    ],
    3: [
        ("sm-facilitation.png", "Facilitation : cadre, parole equilibree, sortie decidee."),
        ("sm-scene-facilitation.png", "Exemple : Sam anime une planning de 40 minutes."),
    ],
    4: [
        ("sm-obstacles.png", "Obstacle = nommer + proprietaire + action."),
    ],
    5: [
        ("sm-focus.png", "Proteger le focus du sprint face aux urgences."),
    ],
    6: [
        ("sm-coaching-po.png", "Coaching PO : clarite et disponibilite, pas pression."),
    ],
    7: [
        ("sm-coaching-dev.png", "Coaching Developers : autonomie et Done partage."),
    ],
    8: [
        ("sm-conflits.png", "Conflits : faits, impact, prochaine etape."),
    ],
    9: [
        ("sm-metriques.png", "Metriques utiles : debit, cycle, sante d'equipe."),
    ],
    10: [
        ("sm-remote.png", "Remote / hybride : plus de cadre, meme sens."),
    ],
    11: [
        ("sm-sans-titre.png", "Commencer sans titre : un geste utile par semaine."),
    ],
    12: [
        ("sm-mini-projet.png", "Mini-projet : plan d'action sur 30 jours."),
    ],
    13: [
        ("sm-retenir.png", "Faciliter, lever, proteger, coacher, tenir une action."),
    ],
    14: [
        ("sm-tendances.png", "Hybride, process legers, impact mesure."),
    ],
    15: [
        ("sm-atelier-facilitation.png", "Atelier : facilitation chronometree avec sortie claire."),
    ],
    16: [
        ("sm-atelier-freins.png", "Atelier : lister, trier, emporter une action."),
        ("sm-scene-freins.png", "Exemple : Max nomme un frein, Sam le suit jusqu'au bout."),
    ],
    17: [
        ("sm-atelier-coaching.png", "Atelier : questions fortes et silence utile."),
        ("sm-scene-coaching.png", "Exemple : Sam coache Lea sans prendre la decision."),
    ],
    18: [
        ("sm-pratiques.png", "Gestes qui tiennent : preparer, tenir le temps, suivre."),
    ],
    19: [
        ("sm-pieges.png", "Pieges : SM secretaire, SM chef, zero frein suivi."),
    ],
    20: [
        ("sm-quiz.png", "Verifier ce que tu as compris, sans inventer."),
    ],
    21: [
        ("sm-felicitations.png", "Bravo. Tu peux servir l'equipe des demain."),
    ],
}

COVER_IMAGE = "sm-couverture.png"

BOOK_TITLE = "Devenir Scrum Master"
BOOK_SHORT = "Devenir Scrum Master"
BOOK_LEAD = "Facilitation, freins, focus et coaching : le role explique pour le terrain."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant Scrum Master"
BOOK_KEYWORDS = "scrum master, facilitation, agile, coaching, formation"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation Scrum Master</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre Devenir Scrum Master + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "devenir-scrum-master-eco.pdf" if args.eco else "devenir-scrum-master.pdf"
    )
