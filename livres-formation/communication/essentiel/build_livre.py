...
OUT_PDF = ROOT.parent.parent / "pdf" / "communication-les-bases.pdf"
...
BOOK_TITLE = "Communication - Les bases"
BOOK_SHORT = "Communication"
BOOK_LEAD = "Message clair, ecoute, canaux et prise de parole : demarrer sans jargon."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant communication"
BOOK_KEYWORDS = "communication, message, ecoute, pitch, reseaux, email, crise, formation, debutant"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation communication</div>
...
def main() -> int:
    ...
    pdf_name = args.pdf_name or (
        "communication-les-bases-eco.pdf" if args.eco else "communication-les-bases.pdf"
    )
