...
| Domaine | Livre | PDF |
|---------|-------|-----|
| Informatique | HTML/CSS, JS bases + suite, Python, Git | `pdf/` (dont `javascript-la-suite.pdf`) |
...
ton naturel, phrases simples, comme une discussion entre amis.
Un enfant doit pouvoir suivre.
