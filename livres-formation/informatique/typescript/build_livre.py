#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre TypeScript - Les bases et genere un PDF telechargeable."""
...
BOOK_CSS = get_book_css("typescript") + """
.illus.illus-scene {
...
OUT_PDF = ROOT.parent.parent / "pdf" / "typescript-les-bases.pdf"
...
CHAPTER_FILES = [
    ...
    "04-annotation.md",
    "05-interfaces.md",
    "06-union-optional.md",
    "07-fonctions.md",
    "08-tableaux.md",
    "09-narrowing.md",
    "10-any-unknown.md",
    "11-erreur-compilateur.md",
    "12-dom-light.md",
    "13-mini-projet.md",
    "14-retenir.md",
    "15-atelier-types.md",
    "16-atelier-interface.md",
    "17-atelier-projet.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("ts-cest-quoi.png", "TypeScript = JavaScript + types verifies avant l'execution."),
        ("ts-scene-garde.png", "Exemple : Lea compare JS flou et TS qui garde les types."),
    ],
    2: [("ts-installer.png", "Fichier .ts + compilateur : le pont vers du .js.")],
    3: [("ts-types-base.png", "string, number, boolean : les briques de base.")],
    4: [("ts-annotation.png", ": type sur une variable = contrat lisible.")],
    5: [
        ("ts-interfaces.png", "Interface : la forme d'un objet, ecrite clairement."),
        ("ts-scene-interface.png", "Exemple : Max dessine nom, age, email avant de coder."),
    ],
    6: [("ts-union.png", "Union | et optionnel ? : plusieurs cas possibles.")],
    7: [("ts-fonctions.png", "Fonction typee : entrees et sortie annoncees.")],
    8: [("ts-tableaux.png", "Tableau typee : une liste d'un meme contrat.")],
    9: [("ts-narrowing.png", "Narrowing : le type se precise dans un if.")],
    10: [("ts-any.png", "any coupe les alarmes. unknown demande de verifier.")],
    11: [
        ("ts-erreurs.png", "Lire une erreur tsc : message, ligne, corriger."),
        ("ts-scene-erreur.png", "Exemple : Sam lit l'erreur au calme avant de patcher."),
    ],
    12: [("ts-dom.png", "DOM typee : element HTML avec des gardes simples.")],
    13: [
        ("ts-mini-projet.png", "Mini-projet : etat type + actions claires."),
        ("ts-scene-projet.png", "Exemple : Lea, Max et Sam valident le compteur type."),
    ],
    14: [("ts-retenir.png", "Types, interfaces, unions, erreurs : la carte.")],
    15: [("ts-atelier-types.png", "Atelier : annoter sans paniquer.")],
    16: [("ts-atelier-interface.png", "Atelier : une interface pour un vrai objet.")],
    17: [("ts-atelier-projet.png", "Atelier : petit projet type de bout en bout.")],
    18: [("ts-erreurs-classiques.png", "Pieges : any partout, ignore, mauvais cast.")],
    19: [("ts-pratiques.png", "Pratiques : strict, noms clairs, petits contrats.")],
    20: [("ts-quiz.png", "Quiz : verifier le filtre types.")],
    21: [("ts-felicitations.png", "Bravo. Tu ajoutes des types sans magie.")],
}

COVER_IMAGE = "ts-couverture.png"

BOOK_TITLE = "TypeScript - Les bases"
BOOK_SHORT = "TypeScript"
BOOK_LEAD = "Ajouter des types a JavaScript pour coder plus sur, explique simplement."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant TypeScript"
BOOK_KEYWORDS = "TypeScript, TS, types, JavaScript, formation, debutant"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation TypeScript - Les bases</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre TypeScript + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "typescript-les-bases-eco.pdf" if args.eco else "typescript-les-bases.pdf"
    )
