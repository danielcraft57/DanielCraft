...
OUT_PDF = ROOT.parent.parent / "pdf" / "go-les-bases.pdf"
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("go-cest-quoi.png", "Go : simple, rapide, concurrent."),
        ("go-scene-api.png", "Nora lance un serveur HTTP en 10 lignes."),
    ],
    2: [("go-installer.png", "go.dev + VS Code : le duo de depart.")],
    3: [("go-premier.png", "package main + func main().")],
    4: [("go-variables.png", ":= raccourci, types stricts.")],
    5: [("go-types.png", "int, float64, string, bool.")],
    6: [("go-conditions.png", "if sans parentheses, switch sans break.")],
    7: [
        ("go-boucles.png", "for : la seule boucle Go."),
        ("go-scene-boucle.png", "Sam parcourt un slice avec range."),
    ],
    8: [("go-fonctions.png", "Retours multiples : (valeur, erreur).")],
    9: [("go-slices-maps.png", "Slice flexible, map cle-valeur.")],
    10: [("go-structs.png", "Struct + methodes, pas de classes.")],
    11: [("go-interfaces.png", "Interfaces implicites.")],
    12: [
        ("go-erreurs.png", "Erreurs = valeurs, if err != nil."),
        ("go-scene-erreur.png", "Max gere err != nil calmement."),
    ],
    13: [
        ("go-mini-projet.png", "Mini-projet : outil CLI de notes."),
        ("go-scene-projet.png", "Nora, Max et Sam valident le projet."),
    ],
    14: [("go-retenir.png", "La carte des notions Go.")],
    15: [("go-atelier-variables.png", "Atelier : variables et Printf.")],
    16: [("go-atelier-fonctions.png", "Atelier : fonctions et retours.")],
    17: [("go-atelier-structs.png", "Atelier : structs et interfaces.")],
    18: [("go-erreurs-classiques.png", "Pieges : nil, shadowing, slice.")],
    19: [("go-pratiques.png", "gofmt, go vet, noms courts.")],
    20: [("go-quiz.png", "Quiz Go bases.")],
    21: [("go-felicitations.png", "Bravo. Tu codes en Go.")],
}

COVER_IMAGE = "go-couverture.png"

BOOK_TITLE = "Go - Les bases"
BOOK_SHORT = "Go"
BOOK_LEAD = "Ecrire des programmes simples, rapides et fiables."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant Go - Niveau Base"
BOOK_KEYWORDS = "Go, Golang, backend, cloud, formation, debutant"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation Go - Les bases</div>
        <h1>{html.escape(BOOK_SHORT)}</h1>
        <p class="lead">{html.escape(BOOK_LEAD)}</p>
        <p class="meta">{html.escape(BOOK_AUTHOR)} - Livre debutant - Pack Backend</p>
      </div>
    </header>
...
def main() -> int:
    ...
    pdf_name = args.pdf_name or ("go-les-bases-eco.pdf" if args.eco else "go-les-bases.pdf")
