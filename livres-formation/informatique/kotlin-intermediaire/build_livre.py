#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble Kotlin - Intermediaire + PDF."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "kotlin-intermediaire.pdf"

CHAPTER_FILES = [
    "01-apres-les-bases.md", "02-collections-avancees.md", "03-extensions.md", "04-sealed.md",
    "05-when-avance.md", "06-scope-functions.md", "07-higher-order.md", "08-delegation.md",
    "09-coroutines-idee.md", "10-flow-idee.md", "11-null-avance.md", "12-multiplateforme-idee.md",
    "13-tests-idee.md", "14-mini-projet.md", "15-retenir.md", "16-atelier-extensions.md",
    "17-atelier-sealed.md", "18-erreurs-classiques.md", "19-bonnes-pratiques.md",
    "20-quiz.md", "21-bravo.md",
]

CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [("kt2-apres-les-bases.png", "Des bases aux idiomes Kotlin."), ("kt2-cover.png", "Couverture Kotlin Intermediaire.")],
    2: [("kt2-collections-avancees.png", "map, filter, groupBy au quotidien.")],
    3: [("kt2-extensions.png", "Enrichir un type sans heritage."), ("kt2-scene1.png", "Extensions et hierarchie sealed.")],
    4: [("kt2-sealed.png", "Etats fermes, when exhaustif.")],
    5: [("kt2-when-avance.png", "when expression et machine a etats.")],
    6: [("kt2-scope-functions.png", "let, run, apply, also, with.")],
    7: [("kt2-higher-order.png", "Passer une fonction en parametre.")],
    8: [("kt2-delegation.png", "by inner et by lazy.")],
    9: [("kt2-coroutines-idee.png", "suspend, launch, concurrence structuree."), ("kt2-scene2.png", "Flux asynchrone.")],
    10: [("kt2-flow-idee.png", "Stream asynchrone Kotlin.")],
    11: [("kt2-null-avance.png", "Null aux frontieres API.")],
    12: [("kt2-multiplateforme-idee.png", "Logique partagee, UI native.")],
    13: [("kt2-tests-idee.png", "Tests metier et runTest.")],
    14: [("kt2-mini-projet.png", "Journal d'humeur : sealed + extensions."), ("kt2-scene3.png", "Stats par humeur.")],
    15: [("kt2-retenir.png", "Carte inter Kotlin.")],
    16: [("kt2-atelier-extensions.png", "Atelier extensions.")],
    17: [("kt2-atelier-sealed.png", "Atelier sealed + when.")],
    18: [("kt2-erreurs-classiques.png", "Pieges classiques.")],
    19: [("kt2-pratiques.png", "Style idiomatique.")],
    20: [("kt2-quiz.png", "Quiz Kotlin inter.")],
    21: [("kt2-felicitations.png", "Bravo. Du Kotlin qui respire.")],
}

COVER_IMAGE = "kt2-cover.png"
BOOK_TITLE = "Kotlin - Intermediaire"
BOOK_SHORT = "Kotlin"
BOOK_LEAD = "Extensions, sealed, scope functions et coroutines (idee) pour du Kotlin idiomatique."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation Kotlin - Niveau Intermediaire"
BOOK_KEYWORDS = "Kotlin, intermediaire, extensions, sealed, coroutines, scope functions"
...
<header class="cover"><img class="cover-art" src="{html.escape(cover)}" alt="Couverture"><div class="cover-copy"><div class="cover-kicker">Kotlin - Intermediaire</div><h1>{html.escape(BOOK_SHORT)}</h1><p class="lead">{html.escape(BOOK_LEAD)}</p><p class="meta">{html.escape(BOOK_AUTHOR)} - Formation Kotlin</p></div></header>
<nav class="toc"><h2 id="sommaire">Sommaire</h2><ol>{"".join(toc)}</ol></nav>
{"".join(sections)}<p class="footer-note">Idiomatique. Exhaustif. Sur.</p></div></body></html>"""
