#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Securite web - Les bases et genere un PDF telechargeable."""
...
BOOK_CSS = get_book_css("securite") + """
.illus.illus-scene {
...
OUT_PDF = ROOT.parent.parent / "pdf" / "securite-web-les-bases.pdf"
...
CHAPTER_FILES = [
    ...
    "07-sauvegardes.md",
    "08-permissions.md",
    "09-injections-idee.md",
    "10-formulaires.md",
    "11-sessions-cookies.md",
    "12-rgpd-idee.md",
    "13-mini-projet.md",
    "14-retenir.md",
    "15-atelier-mdp.md",
    "16-atelier-https.md",
    "17-atelier-checklist.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("sec-cest-quoi.png", "Securite web = habitudes simples avant les outils chers."),
        ("sec-scene-https.png", "Exemple : Lea verifie le cadenas et l'adresse."),
    ],
    2: [("sec-menaces.png", "Menaces courantes : phishing, vols d'acces, oublis.")],
    3: [
        ("sec-mdp.png", "Mot de passe long, unique, dans un gestionnaire."),
        ("sec-scene-mdp.png", "Exemple : Max refuse de reutiliser le meme secret."),
    ],
    4: [("sec-https.png", "HTTPS protege le trajet. Ce n'est pas toute la securite.")],
    5: [
        ("sec-phishing.png", "Phishing : urgence + lien douteux = frein."),
        ("sec-scene-phishing.png", "Exemple : Sam ignore le faux message de compte."),
    ],
    6: [("sec-maj.png", "Mises a jour : fermer les portes deja connues.")],
    7: [("sec-sauvegardes.png", "Sauvegarde = plan B avant le jour J.")],
    8: [("sec-permissions.png", "Moins de droits = moins de casse si un compte fuit.")],
    9: [("sec-injections.png", "Entrees non filtrees : risque. Validation + requetes preparees.")],
    10: [
        ("sec-formulaires.png", "Formulaire = porte d'entree. Controler ce qui arrive."),
        ("sec-scene-entrees.png", "Exemple : Max valide avant d'enregistrer."),
    ],
    11: [("sec-sessions.png", "Sessions et cookies : qui est connecte, jusqu'a quand.")],
    12: [("sec-rgpd.png", "Donnees perso : minimiser, proteger, expliquer.")],
    13: [("sec-mini-projet.png", "Checklist securite d'un petit site.")],
    14: [("sec-retenir.png", "MDP, HTTPS, maj, sauvegarde, mefiance liens.")],
    15: [("sec-atelier-mdp.png", "Atelier : politique de mots de passe.")],
    16: [("sec-atelier-https.png", "Atelier : lire un cadenas correctement.")],
    17: [("sec-atelier-checklist.png", "Atelier : checklist avant mise en ligne.")],
    18: [("sec-erreurs.png", "Erreurs classiques : reemploi MDP, maj ignorees.")],
    19: [("sec-pratiques.png", "Pratiques : freins simples, repetables.")],
    20: [("sec-quiz.png", "Quiz securite web.")],
    21: [("sec-felicitations.png", "Bravo. Tu proteges sans paniquer.")],
}

COVER_IMAGE = "sec-couverture.png"

BOOK_TITLE = "Securite web - Les bases"
BOOK_SHORT = "Securite web"
BOOK_LEAD = "Proteger un site et ses comptes sans paniquer, explique simplement."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant securite web - Niveau Base"
BOOK_KEYWORDS = "securite, web, HTTPS, mots de passe, phishing, formation"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation Securite web - Les bases</div>
        <h1>{html.escape(short)}</h1>
        <p class="lead">{html.escape(lead)}</p>
        <p class="meta">{html.escape(BOOK_AUTHOR)} - Livre debutant - Pack Securite</p>
      </div>
    </header>
    ...
    <p class="footer-note">Tu as les briques. Maintenant, protege sans paniquer.</p>
  </div>
</body>
</html>
"""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre Securite web + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "securite-web-les-bases-eco.pdf" if args.eco else "securite-web-les-bases.pdf"
    )
