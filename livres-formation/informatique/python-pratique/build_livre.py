#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Python - Pratique et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "python-pratique.pdf"
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("py2-carte.png", "Apres les bases : chemins, CSV, CLI, API, projet propre."),
    ],
    2: [
        ("py2-pathlib.png", "Path : des chemins clairs, sans galere de slash."),
    ],
    3: [
...
COVER_IMAGE = "py2-couverture.png"

BOOK_TITLE = "Python - Pratique"
BOOK_SHORT = "Python - Pratique"
BOOK_LEAD = "CSV, CLI, venv, API et bons reflexes : la suite utile apres les bases Python."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation Python intermediaire pratique"
BOOK_KEYWORDS = "Python, pathlib, CSV, argparse, venv, requests, logging, formation"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation informatique - pratique</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre Python Pratique + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "python-pratique-eco.pdf" if args.eco else "python-pratique.pdf"
    )
