#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre JavaScript - La suite et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "javascript-la-suite.pdf"
...
CHAPTER_FILES = [
    ...
    "05-promesses.md",
    "06-async-await.md",
    "07-erreurs-reseau.md",
    "08-fetch-post.md",
    "09-modules.md",
    "10-organiser-projet.md",
    "11-deboguer.md",
    "12-mini-projet.md",
    "13-retenir.md",
    "14-atelier-formulaire.md",
    "15-atelier-fetch.md",
    "16-atelier-modules.md",
    "17-cors.md",
    "18-debounce.md",
    "19-perf.md",
    "20-quiz.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("js2-carte.png", "Apres les bases : formulaires, JSON, fetch, async, modules."),
    ],
    2: [
...
COVER_IMAGE = "js2-couverture.png"

BOOK_TITLE = "JavaScript - La suite"
BOOK_SHORT = "JavaScript - La suite"
BOOK_LEAD = "Formulaires, JSON, fetch, async/await et modules : la suite solide apres les bases."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation JavaScript intermediaire"
BOOK_KEYWORDS = "JavaScript, fetch, async, await, JSON, modules, formulaires, formation"
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre JavaScript La suite + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "javascript-la-suite-eco.pdf" if args.eco else "javascript-la-suite.pdf"
    )
