#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Kotlin - Les bases et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "kotlin-les-bases.pdf"
...
CHAPTER_FILES = [
    ...
    "14-mini-projet.md",
    "15-retenir.md",
    "16-atelier-variables.md",
    "17-atelier-fonctions.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("kotlin-cest-quoi.png", "Kotlin : concision + JVM + Android."),
        ("kotlin-cover.png", "Couverture Kotlin."),
    ],
    2: [("kotlin-installer.png", "IntelliJ + Gradle : pret en minutes.")],
    3: [("kotlin-premier-programme.png", "fun main() et println : premier programme.")],
    4: [("kotlin-variables.png", "val immutable, var mutable.")],
    5: [("kotlin-types.png", "Int, Double, String, nullable ?.")],
    6: [("kotlin-conditions.png", "if expression + when.")],
    7: [
        ("kotlin-boucles.png", "for, while, forEach."),
        ("kotlin-scene1.png", "Coder en Kotlin au quotidien."),
    ],
    8: [("kotlin-fonctions.png", "Fonctions et lambdas.")],
    9: [
        ("kotlin-null-safety.png", "Null safety : le coeur de Kotlin."),
        ("kotlin-scene2.png", "Visualiser ?. et ?:"),
    ],
    10: [("kotlin-classes-objets.png", "Classes et objets.")],
    11: [("kotlin-data-classes.png", "Data classes.")],
    12: [("kotlin-collections.png", "listOf, filter, map.")],
    13: [
        ("kotlin-erreurs.png", "Result et runCatching."),
        ("kotlin-scene3.png", "Kotlin pour Android."),
    ],
    14: [("kotlin-mini-projet.png", "Mini-projet : liste de courses CLI.")],
    15: [("kotlin-retenir.png", "Carte des notions Kotlin.")],
    16: [("kotlin-atelier-variables.png", "Atelier : variables.")],
    17: [("kotlin-atelier-fonctions.png", "Atelier : fonctions.")],
    18: [("kotlin-erreurs-classiques.png", "Pieges classiques Kotlin.")],
    19: [("kotlin-pratiques.png", "Bonnes pratiques idiomatiques.")],
    20: [("kotlin-quiz.png", "Quiz Kotlin bases.")],
    21: [("kotlin-felicitations.png", "Bravo. Tu codes en Kotlin.")],
}

COVER_IMAGE = "kotlin-cover.png"

BOOK_TITLE = "Kotlin - Les bases"
BOOK_SHORT = "Kotlin"
BOOK_LEAD = "Apprendre le langage moderne Android et JVM, pas a pas."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant Kotlin - Niveau Base"
BOOK_KEYWORDS = "Kotlin, Android, JVM, programmation, debutant, formation, bases"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation Kotlin - Les bases</div>
        <h1>{html.escape(BOOK_SHORT)}</h1>
        <p class="lead">{html.escape(BOOK_LEAD)}</p>
        <p class="meta">{html.escape(BOOK_AUTHOR)} - Livre debutant - Pack Mobile & JVM</p>
      </div>
    </header>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre Kotlin + PDF")
    ...
    pdf_name = args.pdf_name or ("kotlin-les-bases-eco.pdf" if args.eco else "kotlin-les-bases.pdf")
