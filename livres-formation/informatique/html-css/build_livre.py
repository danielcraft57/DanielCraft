...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("html-css-maison.png", "A gauche la structure. A droite le style. HTML puis CSS."),
        ("html-css-scene-maison.png", "Exemple : sans CSS vs avec CSS, meme contenu."),
    ],
    2: [
    ...
    4: [
        ("html-css-texte.png", "h1, h2, h3, p : la hierarchie du texte."),
    ],
    5: [
        ("html-css-liens-images.png", "Lien = route. Image = preuve visuelle avec alt."),
    ],
    6: [
        ("html-css-listes-tableaux.png", "ul libre, ol ordonne, table pour les croisements."),
    ],
    7: [
        ("html-css-formulaires.png", "Label, champ, bouton : un guichet clair."),
        ("html-css-scene-formulaire.png", "Exemple : label visible au-dessus du champ."),
    ],
    8: [
        ("html-css-css-arrive.png", "HTML + link + fichier CSS separe."),
    ],
    9: [
        ("html-css-couleurs-polices.png", "Fond, texte, titres : contraste utile."),
    ],
    10: [
    ...
    11: [
        ...
        ("html-css-scene-flex.png", "Exemple : trois cartes alignees avec flex."),
    ],
    12: [
    ...
    13: [
        ...
        ("html-css-scene-page.png", "Exemple : ta page ouverte dans le navigateur."),
    ],
    14: [
        ("html-css-retenir.png", "Carte des bases : structure, style, boites, flex, telephone."),
    ],
    15: [
        ("html-css-atelier-debug.png", "Symptome, dernier changement, chemins, simplifier, retester."),
    ],
    16: [
        ("html-css-atelier-produit.png", "Nom, prix, preuves, action : hierarchie visuelle."),
    ],
    17: [
        ("html-css-accessibilite.png", "alt, labels, contraste : chemins praticables."),
    ],
    18: [
        ("html-css-quiz.png", "Verifier ce que tu as compris, sans inventer."),
    ],
    19: [
