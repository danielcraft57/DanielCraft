...
OUT_PDF = ROOT.parent.parent / "pdf" / "go-intermediaire.pdf"

CHAPTER_FILES = [
    "01-apres-les-bases.md", "02-pointeurs.md", "03-methodes-receivers.md", "04-interfaces-avancees.md",
    "05-erreurs-idiomes.md", "06-packages-modules.md", "07-goroutines.md", "08-channels.md",
    "09-select-context.md", "10-json-http-idee.md", "11-tests-idee.md", "12-tables-tests.md",
    "13-outils.md", "14-mini-projet.md", "15-retenir.md", "16-atelier-interfaces.md",
    "17-atelier-channels.md", "18-erreurs-classiques.md", "19-bonnes-pratiques.md",
    "20-quiz.md", "21-bravo.md",
]

CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [("go2-apres-les-bases.png", "Des bases aux outils du quotidien."), ("go2-cover.png", "Couverture Go Intermediaire.")],
    2: [("go2-pointeurs.png", "Pointeurs : adresse vs copie.")],
    3: [("go2-methodes-receivers.png", "Receiver valeur ou pointeur.")],
    4: [("go2-interfaces-avancees.png", "Assertion, type switch, any.")],
    5: [("go2-erreurs-idiomes.png", "Erreurs wrappees, Is et As.")],
    6: [("go2-packages-modules.png", "go.mod, export, internal.")],
    7: [("go2-goroutines.png", "go keyword et WaitGroup."), ("go2-scene1.png", "Goroutines en parallele.")],
    8: [("go2-channels.png", "Envoi, reception, buffer."), ("go2-scene2.png", "Flux via channels.")],
    9: [("go2-select-context.png", "select et context.WithCancel.")],
    10: [("go2-json-http-idee.png", "JSON et HTTP basique.")],
    11: [("go2-tests-idee.png", "Tests : verifier le comportement.")],
    12: [("go2-tables-tests.png", "Tests table-driven.")],
    13: [("go2-outils.png", "gofmt, go vet, race detector.")],
    14: [("go2-mini-projet.png", "Mini-projet CLI concurrent."), ("go2-scene3.png", "Goroutines, channels et tests.")],
    15: [("go2-retenir.png", "Carte inter Go.")],
    16: [("go2-atelier-interfaces.png", "Atelier interfaces.")],
    17: [("go2-atelier-channels.png", "Atelier channels.")],
    18: [("go2-erreurs-classiques.png", "Pieges courants.")],
    19: [("go2-pratiques.png", "Discipline pro.")],
    20: [("go2-quiz.png", "Quiz Go intermediaire.")],
    21: [("go2-felicitations.png", "Bravo. Du Go clair, c'est du Go durable.")],
}

COVER_IMAGE = "go2-cover.png"
BOOK_TITLE = "Go - Intermediaire"
BOOK_SHORT = "Go"
BOOK_LEAD = "Interfaces, goroutines, channels, erreurs et packages pour du Go solide."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation Go - Niveau Intermediaire - Pack langages"
BOOK_KEYWORDS = "Go, goroutines, channels, interfaces, erreurs, tests, formation"
...
<header class="cover"><img class="cover-art" src="{html.escape(cover)}" alt="Couverture"><div class="cover-copy"><div class="cover-kicker">Go - Intermediaire</div><h1>{html.escape(BOOK_SHORT)}</h1><p class="lead">{html.escape(BOOK_LEAD)}</p><p class="meta">{html.escape(BOOK_AUTHOR)} - Pack langages</p></div></header>
<nav class="toc"><h2 id="sommaire">Sommaire</h2><ol>{"".join(toc)}</ol></nav>
{"".join(sections)}<p class="footer-note">Tu structures. Tu synchronises. Tu livres.</p></div></body></html>"""
