#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Git et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "git-les-bases.pdf"
...
CHAPTER_FILES = [
    ...
    "18-atelier-equipe.md",
    "19-atelier-reparer.md",
    "20-quiz.md",
    "21-bravo.md",
]
...
COVER_IMAGE = "git-couverture.png"

BOOK_TITLE = "Git et GitHub - Les bases"
BOOK_SHORT = "Git"
BOOK_LEAD = "Garder l'historique de son code, collaborer sans se marcher dessus."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant Git et GitHub"
BOOK_KEYWORDS = "Git, GitHub, versioning, branches, pull request, formation, debutant"
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre Git + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "git-les-bases-eco.pdf" if args.eco else "git-les-bases.pdf"
    )
