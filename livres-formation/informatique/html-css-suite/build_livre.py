#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre HTML et CSS - La suite et genere un PDF telechargeable."""
...
BOOK_CSS = get_book_css("htmlcss2") + """
.illus.illus-scene {
...
OUT_PDF = ROOT.parent.parent / "pdf" / "html-css-la-suite.pdf"

CHAPTER_FILES = [
    "01-rappel.md",
    "02-semantique.md",
    "03-cascade-specificite.md",
    "04-variables-css.md",
    "05-grid.md",
    "06-grid-mise-en-page.md",
    "07-flex-vs-grid.md",
    "08-images-modernes.md",
    "09-formulaires-style.md",
    "10-transitions.md",
    "11-accessibilite-suite.md",
    "12-mini-projet.md",
    "13-retenir.md",
    "14-atelier-grid.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("css2-carte.png", "Apres les bases : semantique, cascade, variables, Grid, a11y."),
    ],
    2: [
        ("css2-semantique.png", "Nommer les pieces : header, main, nav, article, footer."),
    ],
    3: [
        ("css2-cascade.png", "Cascade et specificite : qui gagne, sans paniquer."),
    ],
    4: [
        ("css2-variables.png", "Variables CSS : une couleur, un endroit."),
    ],
    5: [
        ("css2-grid.png", "Grid : lignes, colonnes, gap."),
        ("css2-scene-grid.png", "Exemple : une page decoupee en zones claires."),
    ],
    6: [
        ("css2-grid-page.png", "Header, nav, contenu, aside, pied : la grille de page."),
    ],
    7: [
        ("css2-flexgrid.png", "Flex ou Grid : choisir le bon outil."),
    ],
    8: [
        ("css2-images.png", "srcset, format leger, alt utile."),
    ],
    9: [
        ("css2-formulaires.png", "Labels clairs, champs lisibles, bouton net."),
    ],
    10: [
        ("css2-transitions.png", "Transitions : un changement doux, pas un spectacle."),
    ],
    11: [
        ("css2-a11y.png", "Clavier, contraste, texte alternatif."),
        ("css2-scene-a11y.png", "Exemple : naviguer au clavier avec un focus visible."),
    ],
    12: [
        ("css2-projet.png", "Mini-projet : page d'accueil responsive."),
    ],
    13: [
        ("css2-retenir.png", "Carte de la suite HTML/CSS."),
    ],
    14: [
        ("css2-atelier-grid.png", "Atelier : poser la grille, puis remplir."),
    ],
    15: [
        ("css2-atelier-vars.png", "Atelier : :root pour piloter le theme."),
    ],
    16: [
        ("css2-atelier-page.png", "Atelier : assembler une page complete."),
    ],
    17: [
        ("css2-dark.png", "Clair / sombre : memes zones, autres couleurs."),
        ("css2-scene-dark.png", "Exemple : un theme sombre sans tout recopier."),
    ],
    18: [
        ("css2-perf.png", "CSS utile, images legeres, ressenti rapide."),
    ],
    19: [
        ("css2-debug.png", "F12 : element, regles, qui gagne."),
    ],
    20: [
        ("css2-quiz.png", "Verifier ce que tu as compris."),
    ],
    21: [
        ("css2-felicitations.png", "Bravo. Tu sais poser des pages plus solides."),
    ],
}

COVER_IMAGE = "css2-couverture.png"

BOOK_TITLE = "HTML et CSS - La suite"
BOOK_SHORT = "HTML et CSS - La suite"
BOOK_LEAD = "Semantique, cascade, variables, Grid, images et a11y : la suite apres les bases."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation HTML CSS intermediaire"
BOOK_KEYWORDS = "HTML, CSS, Grid, variables, semantic, accessibilite, formation"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation informatique - suite</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre HTML CSS La suite + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "html-css-la-suite-eco.pdf" if args.eco else "html-css-la-suite.pdf"
    )
