#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble Securite web - Expert + PDF."""
...
BOOK_CSS = get_book_css("securite3") + """
...
OUT_PDF = ROOT.parent.parent / "pdf" / "securite-web-expert.pdf"

CHAPTER_FILES = [
    "01-apres-inter.md", "02-menace-modelisation.md", "03-zero-trust.md", "04-oauth-oidc.md",
    "05-api-securite-avancee.md", "06-ssrf-defense.md", "07-upload-fichiers.md", "08-deserialisation.md",
    "09-supply-chain.md", "10-waf-proxy.md", "11-reponse-incident.md", "12-securite-cicd.md",
    "13-containers-k8s.md", "14-rotation-secrets.md", "15-mini-projet.md", "16-retenir.md",
    "17-atelier-menace.md", "18-atelier-api-audit.md", "19-erreurs-classiques.md",
    "20-quiz.md", "21-bravo.md",
]

CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [("sec3-apres-inter.png", "Du code durci a l'architecture."), ("sec3-cover.png", "Couverture Securite expert.")],
    2: [("sec3-menace-modelisation.png", "STRIDE en defense."), ("sec3-scene1.png", "Architecture securisee.")],
    3: [("sec3-zero-trust.png", "Verifier chaque requete.")],
    4: [("sec3-oauth-oidc.png", "OAuth2 + OIDC.")],
    5: [("sec3-api-securite-avancee.png", "API production-ready.")],
    6: [("sec3-ssrf-defense.png", "Bloquer les appels internes.")],
    7: [("sec3-upload-fichiers.png", "Upload sans execution.")],
    8: [("sec3-deserialisation.png", "JSON plutot que binaire.")],
    9: [("sec3-supply-chain.png", "Audit des dependances."), ("sec3-scene2.png", "Pipeline securisee.")],
    10: [("sec3-waf-proxy.png", "Filtrage edge.")],
    11: [("sec3-reponse-incident.png", "Runbook et post-mortem."), ("sec3-scene3.png", "Gestion d'incident.")],
    12: [("sec3-securite-cicd.png", "SAST, scan image, secrets.")],
    13: [("sec3-containers-k8s.png", "Non-root, RBAC, NetworkPolicy.")],
    14: [("sec3-rotation-secrets.png", "Vault et rotation.")],
    15: [("sec3-mini-projet.png", "Architecture multi-tenant.")],
    16: [("sec3-retenir.png", "Carte expert.")],
    17: [("sec3-atelier-menace.png", "Atelier STRIDE.")],
    18: [("sec3-atelier-api-audit.png", "Atelier audit API.")],
    19: [("sec3-erreurs-classiques.png", "Pieges organisationnels.")],
    20: [("sec3-quiz.png", "Quiz securite expert.")],
    21: [("sec3-felicitations.png", "Bravo. Tu es pret pour la prod.")],
}

COVER_IMAGE = "sec3-cover.png"
BOOK_TITLE = "Securite web - Expert"
BOOK_SHORT = "Securite web"
BOOK_LEAD = "Architecture defensive, zero trust, supply chain, CI/CD et reponse a incident."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation securite web - Niveau Expert (defense only)"
BOOK_KEYWORDS = "securite, web, expert, STRIDE, zero trust, OAuth, SSRF, CI/CD, incident"
...
<header class="cover"><img class="cover-art" src="{html.escape(cover)}" alt="Couverture"><div class="cover-copy"><div class="cover-kicker">Securite web - Expert</div><h1>{html.escape(BOOK_SHORT)}</h1><p class="lead">{html.escape(BOOK_LEAD)}</p><p class="meta">{html.escape(BOOK_AUTHOR)} - Defense only - Pack Securite</p></div></header>
<nav class="toc"><h2 id="sommaire">Sommaire</h2><ol>{"".join(toc)}</ol></nav>
{"".join(sections)}<p class="footer-note">Tu concois. Tu proteges. Tu reagis.</p></div></body></html>"""
