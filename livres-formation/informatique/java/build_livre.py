#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Java - Intermediaire et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "java-les-bases.pdf"
...
CHAPTER_FILES = [
    ...
    "16-atelier-methodes.md",
    "17-atelier-classe.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("java-cest-quoi.png", "Java : tu ecris du code, la machine virtuelle execute."),
        ("java-scene-classe.png", "Exemple : Lea ouvre sa premiere classe."),
    ],
    2: [("java-installer.png", "JDK + fichier .java : le duo de depart.")],
    3: [("java-premier.png", "Classe + methode main : le point d'entree.")],
    4: [("java-variables.png", "Variable = boite nommee avec une valeur.")],
    5: [("java-types.png", "int, double, boolean, String : les types utiles.")],
    6: [("java-conditions.png", "if / else : choisir un chemin.")],
    7: [
        ("java-boucles.png", "for / while : repeter sans copier-coller."),
        ("java-scene-boucle.png", "Exemple : Sam compte avec une boucle."),
    ],
    8: [("java-methodes.png", "Methode : ecrire une fois, appeler souvent.")],
    9: [("java-tableaux.png", "Tableau : une liste d'elements indexes.")],
    10: [("java-classes.png", "Classe = plan. Objet = exemplaire.")],
    11: [("java-constructeurs.png", "Constructeur : preparer l'objet a la creation.")],
    12: [
        ("java-erreurs.png", "Lire une erreur : message, ligne, corriger."),
        ("java-scene-erreur.png", "Exemple : Max lit la ligne avant de paniquer."),
    ],
    13: [
        ("java-mini-projet.png", "Mini-projet : un petit programme qui tient debout."),
        ("java-scene-projet.png", "Exemple : Lea, Max et Sam valident le mini-projet."),
    ],
    14: [("java-retenir.png", "Variables, methodes, objets : la carte.")],
    15: [("java-atelier-variables.png", "Atelier : declarer et afficher.")],
    16: [("java-atelier-methodes.png", "Atelier : decouper en methodes.")],
    17: [("java-atelier-classe.png", "Atelier : une petite classe metier.")],
    18: [("java-erreurs-classiques.png", "Pieges : ; oublie, types, NullPointer.")],
    19: [("java-pratiques.png", "Pratiques : noms clairs, petits pas, tester.")],
    20: [("java-quiz.png", "Quiz Java bases.")],
    21: [("java-felicitations.png", "Bravo. Tu ecris du Java sans magie.")],
}

COVER_IMAGE = "java-couverture.png"

BOOK_TITLE = "Java - Les bases"
BOOK_SHORT = "Java"
BOOK_LEAD = "Ecrire des programmes clairs, etape par etape."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant Java - Niveau Base"
BOOK_KEYWORDS = "Java, JVM, classes, methodes, formation, debutant"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation Java - Les bases</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre Java + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "sql-les-bases-eco.pdf" if args.eco else "java-les-bases.pdf"
    )
