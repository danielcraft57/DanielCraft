...
OUT_PDF = ROOT.parent.parent / "pdf" / "csharp-les-bases.pdf"
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("csharp-cest-quoi.png", "C# : type, moderne, polyvalent."),
        ("csharp-scene-classe.png", "Nora decouvre C# avec Unity."),
    ],
    2: [("csharp-installer.png", "SDK .NET + VS Code : le duo de depart.")],
    3: [("csharp-premier.png", "Console.WriteLine : ta premiere ligne.")],
    4: [("csharp-variables.png", "Variable = type + nom + valeur.")],
    5: [("csharp-types.png", "int, double, decimal, string, bool.")],
    6: [("csharp-conditions.png", "if / else if / switch.")],
    7: [
        ("csharp-boucles.png", "for / foreach / while."),
        ("csharp-scene-boucle.png", "Sam parcourt une collection."),
    ],
    8: [("csharp-methodes.png", "Methode : type retour + nom + params.")],
    9: [("csharp-tableaux-listes.png", "Array fixe vs List<T> flexible.")],
    10: [("csharp-classes-objets.png", "Classe = plan. Objet = instance.")],
    11: [("csharp-heritage.png", "Heritage : parent -> enfant.")],
    12: [
        ("csharp-erreurs.png", "try/catch/finally."),
        ("csharp-scene-erreur.png", "Max lit la NullReferenceException."),
    ],
    13: [
        ("csharp-mini-projet.png", "Mini-projet : gestionnaire de taches."),
        ("csharp-scene-projet.png", "Nora, Max et Sam valident le projet."),
    ],
    14: [("csharp-retenir.png", "La carte des notions C#.")],
    15: [("csharp-atelier-variables.png", "Atelier : variables et types.")],
    16: [("csharp-atelier-methodes.png", "Atelier : creer des methodes.")],
    17: [("csharp-atelier-classes.png", "Atelier : modeliser avec des classes.")],
    18: [("csharp-erreurs-classiques.png", "Pieges : null, index, iteration.")],
    19: [("csharp-pratiques.png", "PascalCase, petites methodes, analyseur.")],
    20: [("csharp-quiz.png", "Quiz C# bases.")],
    21: [("csharp-felicitations.png", "Bravo. Tu codes en C#.")],
}

COVER_IMAGE = "csharp-couverture.png"

BOOK_TITLE = "C# - Les bases"
BOOK_SHORT = "C#"
BOOK_LEAD = "Ecrire des applications modernes et typees, pas a pas."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant C# - Niveau Base"
BOOK_KEYWORDS = "C#, .NET, Unity, programmation, debutant, formation"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation C# - Les bases</div>
...
def main() -> int:
    ...
    pdf_name = args.pdf_name or ("csharp-les-bases-eco.pdf" if args.eco else "csharp-les-bases.pdf")
