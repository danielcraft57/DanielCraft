#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre SQL - Les bases et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "sql-les-bases.pdf"
...
CHAPTER_FILES = [
    ...
    "10-delete.md",
    "11-cles.md",
    "12-types-colonnes.md",
    "13-mini-projet.md",
    "14-retenir.md",
    "15-atelier-select.md",
    "16-atelier-filtre.md",
    "17-atelier-jointure.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("sql-cest-quoi.png", "SQL : poser une question claire a des tables."),
        ("sql-scene-table.png", "Exemple : Lea lit une table clients comme une grille."),
    ],
    2: [("sql-select.png", "SELECT ... FROM : choisir colonnes et table.")],
    3: [
        ("sql-where.png", "WHERE : garder seulement les lignes utiles."),
        ("sql-scene-filtre.png", "Exemple : Max filtre les commandes du jour."),
    ],
    4: [("sql-order-limit.png", "ORDER BY trie. LIMIT coupe la liste.")],
    5: [("sql-null.png", "NULL = valeur absente. Pas zero, pas texte vide.")],
    6: [("sql-agregats.png", "COUNT SUM AVG MIN MAX + GROUP BY.")],
    7: [
        ("sql-join.png", "INNER JOIN : croiser deux tables sur une cle."),
        ("sql-scene-jointure.png", "Exemple : Sam relie clients et commandes."),
    ],
    8: [("sql-left-join.png", "LEFT JOIN : garder la gauche meme sans match.")],
    9: [("sql-insert-update.png", "INSERT ajoute. UPDATE modifie (avec WHERE).")],
    10: [("sql-delete.png", "DELETE retire des lignes. Toujours verifier WHERE.")],
    11: [("sql-cles.png", "Cle primaire et cle etrangere : le lien.")],
    12: [("sql-types-colonnes.png", "Types de colonnes : texte, nombre, date...")],
    13: [
        ("sql-mini-projet.png", "Mini-projet : requetes sur clients et commandes."),
        ("sql-scene-projet.png", "Exemple : Lea, Max et Sam livrent le rapport."),
    ],
    14: [("sql-retenir.png", "SELECT WHERE JOIN : la carte a garder.")],
    15: [("sql-atelier-select.png", "Atelier : lire des colonnes sans paniquer.")],
    16: [("sql-atelier-filtre.png", "Atelier : filtrer avec WHERE.")],
    17: [("sql-atelier-jointure.png", "Atelier : croiser deux tables.")],
    18: [("sql-erreurs-classiques.png", "Pieges : WHERE oublie, JOIN flou, NULL.")],
    19: [("sql-pratiques.png", "Pratiques : petit, clair, testable.")],
    20: [("sql-quiz.png", "Quiz : verifier le filtre SQL.")],
    21: [("sql-felicitations.png", "Bravo. Tu interroges des tables sans magie.")],
}

COVER_IMAGE = "sql-couverture.png"

BOOK_TITLE = "SQL - Les bases"
BOOK_SHORT = "SQL"
BOOK_LEAD = "Interroger des tables et lire des resultats, explique simplement."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant SQL - pack Data/SQL - Niveau Base"
BOOK_KEYWORDS = "SQL, SELECT, WHERE, JOIN, tables, formation, debutant, Data"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation SQL - Les bases</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre SQL + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "sql-les-bases-eco.pdf" if args.eco else "sql-les-bases.pdf"
    )
