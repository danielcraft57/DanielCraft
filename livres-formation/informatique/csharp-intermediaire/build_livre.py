...
OUT_PDF = ROOT.parent.parent / "pdf" / "csharp-intermediaire.pdf"

CHAPTER_FILES = [
    "01-apres-les-bases.md", "02-collections.md", "03-generics.md", "04-linq.md",
    "05-delegates-events.md", "06-async-await.md", "07-exceptions.md", "08-fichiers.md",
    "09-records.md", "10-nullable.md", "11-interfaces-di-idee.md", "12-tests-idee.md",
    "13-properties-patterns.md", "14-mini-projet.md", "15-retenir.md", "16-atelier-linq.md",
    "17-atelier-async.md", "18-erreurs-classiques.md", "19-bonnes-pratiques.md",
    "20-quiz.md", "21-bravo.md",
]

CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [("cs2-apres-les-bases.png", "Des bases aux outils du quotidien."), ("cs2-cover.png", "Couverture C# Intermediaire.")],
    2: [("cs2-collections.png", "List, Dictionary, HashSet : choisir la bonne structure.")],
    3: [("cs2-generics.png", "Generics : typer sans caster.")],
    4: [("cs2-linq.png", "LINQ : Where, Select, GroupBy."), ("cs2-scene1.png", "LINQ en pipeline.")],
    5: [("cs2-delegates-events.png", "Delegates et events : Action, Func.")],
    6: [("cs2-async-await.png", "Async/await : Task sans bloquer."), ("cs2-scene2.png", "Operations async en chaine.")],
    7: [("cs2-exceptions.png", "Exceptions : signaler, pas avaler.")],
    8: [("cs2-fichiers.png", "File, Path, StreamReader.")],
    9: [("cs2-records.png", "Record : donnees immuables.")],
    10: [("cs2-nullable.png", "Nullable reference types : intention explicite.")],
    11: [("cs2-interfaces-di-idee.png", "Interfaces et injection de dependances.")],
    12: [("cs2-tests-idee.png", "Tests xUnit : verifier le comportement.")],
    13: [("cs2-properties-patterns.png", "Properties et pattern matching.")],
    14: [("cs2-mini-projet.png", "Mini-projet liste de taches async."), ("cs2-scene3.png", "Collections, LINQ et fichiers.")],
    15: [("cs2-retenir.png", "Carte inter C#.")],
    16: [("cs2-atelier-linq.png", "Atelier LINQ.")],
    17: [("cs2-atelier-async.png", "Atelier async.")],
    18: [("cs2-erreurs-classiques.png", "Pieges courants.")],
    19: [("cs2-pratiques.png", "Discipline pro.")],
    20: [("cs2-quiz.png", "Quiz C# intermediaire.")],
    21: [("cs2-felicitations.png", "Bravo. Du C# clair, c'est du C# durable.")],
}

COVER_IMAGE = "cs2-cover.png"
BOOK_TITLE = "C# - Intermediaire"
BOOK_SHORT = "C#"
BOOK_LEAD = "LINQ, async/await, generics, records et fichiers pour du C# moderne."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation C# - Niveau Intermediaire - Pack C# / langages"
BOOK_KEYWORDS = "C#, LINQ, async, generics, records, fichiers, nullable, formation"
...
def inject_figures(body: str, figs: list[tuple[str, str]], image_map: dict[str, str]) -> str:
    if not figs:
        return body
    schemas = [(s, c) for s, c in figs if "-scene" not in s and "cover" not in s and "felicitations" not in s]
    scenes = [(s, c) for s, c in figs if "-scene" in s or "cover" in s or "felicitations" in s]
    if schemas:
...
<header class="cover"><img class="cover-art" src="{html.escape(cover)}" alt="Couverture"><div class="cover-copy"><div class="cover-kicker">C# - Intermediaire</div><h1>{html.escape(BOOK_SHORT)}</h1><p class="lead">{html.escape(BOOK_LEAD)}</p><p class="meta">{html.escape(BOOK_AUTHOR)} - Pack C# / langages</p></div></header>
<nav class="toc"><h2 id="sommaire">Sommaire</h2><ol>{"".join(toc)}</ol></nav>
{"".join(sections)}<p class="footer-note">Tu structures. Tu LINQ. Tu livres.</p></div></body></html>"""
