...
CHAPTER_FILES = [
    ...
    "13-mini-projet.md",
    "14-retenir.md",
    "15-atelier-sous-requete.md",
    "16-atelier-case-having.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [("sql2-rappel.png", "Rappel : SELECT WHERE JOIN avant d avancer.")],
    2: [
        ("sql2-sous-requetes.png", "Sous-requete : une question dans une question."),
        ("sql2-scene-sous-requete.png", "Exemple : Lea filtre d abord, puis calcule."),
    ],
    3: [("sql2-correlees.png", "Sous-requete correlee : depend de la ligne du dehors.")],
    4: [("sql2-exists.png", "EXISTS / IN : tester la presence.")],
    5: [
        ("sql2-case.png", "CASE : si / alors en SQL."),
        ("sql2-scene-case.png", "Exemple : Max classe gros / petit montant."),
    ],
    6: [
        ("sql2-having.png", "HAVING filtre apres GROUP BY."),
        ("sql2-scene-having.png", "Exemple : Sam garde les groupes utiles."),
    ],
    7: [("sql2-joins-multi.png", "Plusieurs JOIN : lire le chemin des cles.")],
    8: [("sql2-union.png", "UNION : empiler des resultats semblables.")],
    9: [("sql2-vues.png", "Vue : requete enregistree comme une table." )],
    10: [("sql2-fenetre.png", "Fonctions fenetre : idee classement / running.")],
    11: [("sql2-cte.png", "CTE (WITH) : etapes nommees, plus lisibles.")],
    12: [("sql2-perf.png", "Perf idee : moins de lignes tot, index, expliquer.")],
    13: [
        ("sql2-mini-projet.png", "Mini-projet : rapport clients / commandes."),
        ("sql2-scene-projet.png", "Exemple : Lea Max Sam livrent le classement."),
    ],
    14: [("sql2-retenir.png", "Sous-requete, CASE, HAVING, CTE : la carte.")],
    15: [("sql2-atelier-sous.png", "Atelier sous-requete.")],
    16: [("sql2-atelier-case.png", "Atelier CASE + HAVING.")],
    17: [("sql2-atelier-rapport.png", "Atelier rapport multi-jointures.")],
    18: [("sql2-erreurs.png", "Pieges : HAVING vs WHERE, sous-requetes lourdes.")],
    19: [("sql2-pratiques.png", "Pratiques : etapes, noms, echantillon.")],
    20: [("sql2-quiz.png", "Quiz intermediaire.")],
    21: [("sql2-felicitations.png", "Bravo. Tu enchaines les questions SQL.")],
}
...
BOOK_LEAD = "Sous-requetes, CASE, HAVING et jointures plus riches, apres les bases."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation SQL intermediaire - pack Data - Niveau Inter"
BOOK_KEYWORDS = "SQL, sous-requete, CASE, HAVING, JOIN, intermediaire"
