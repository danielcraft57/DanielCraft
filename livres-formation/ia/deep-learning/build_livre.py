#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre IA - Deep Learning et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "ia-deep-learning.pdf"
...
CHAPTER_FILES = [
    ...
    "07-rnn.md",
    "08-transformers.md",
    "09-overfitting-dl.md",
    "10-gpu.md",
    "11-transfer-learning.md",
    "12-llm-lien.md",
    "13-retenir.md",
    "14-atelier-intuition.md",
    "15-atelier-cnn.md",
    "16-atelier-transformer.md",
    "17-choix-archi.md",
    "18-limites.md",
...
COVER_IMAGE = "dl-couverture.png"

BOOK_TITLE = "IA - Deep Learning"
BOOK_SHORT = "Deep Learning"
BOOK_LEAD = "Neurones, CNN, transformers et limites : comprendre le deep learning simplement."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant deep learning"
BOOK_KEYWORDS = "deep learning, CNN, transformers, neurones, GPU, formation"
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation IA - Deep Learning</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre IA Deep Learning + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "ia-deep-learning-eco.pdf" if args.eco else "ia-deep-learning.pdf"
    )
