...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [("ml-carte.png", "Machine learning : apprendre a partir d'exemples.")],
    2: [("ml-supervise.png", "Supervise : etiquettes + predictions.")],
    9: [("ml-overfit.png", "Surapprentissage : trop coller aux exemples.")],
    11: [("ml-pipeline.png", "Pipeline : donnees, modele, evaluation.")],
    12: [("ml-projet.png", "Donnees biaisees = predictions biaisees.")],
