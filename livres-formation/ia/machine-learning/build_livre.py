#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre IA - Machine Learning et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "ia-machine-learning.pdf"
...
CHAPTER_FILES = [
    ...
    "13-scikit-learn.md",
    "14-retenir.md",
    "15-atelier-regression.md",
    "16-atelier-classification.md",
    "17-atelier-pipeline.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("ml-carte.png", "Machine learning : apprendre a partir d'exemples."),
        ("ml-scene-exemples.png", "Exemple : Noe montre des mails labels au modele."),
    ],
    2: [("ml-supervise.png", "Supervise : etiquettes + predictions.")],
    3: [("ml-non-supervise.png", "Non supervise : regrouper sans label.")],
    4: [("ml-regression.png", "Regression : predire un nombre.")],
    5: [("ml-classification.png", "Classification : predire une classe.")],
    6: [("ml-arbres.png", "Arbre : questions en cascade jusqu'a une feuille.")],
    7: [("ml-features.png", "Features : ce que le modele voit, dispo a l'instant T.")],
    8: [("ml-train-test.png", "Train pour apprendre, test pour evaluer.")],
    9: [
        ("ml-overfit.png", "Overfitting : coller au train, rater le futur."),
        ("ml-scene-overfit.png", "Exemple : Lea compare le score train et le score test."),
    ],
    10: [("ml-metriques.png", "Metriques : accuracy, precision, rappel, cout metier.")],
    11: [
        ("ml-pipeline.png", "Pipeline : donnees, prepare, modele, evaluation."),
        ("ml-scene-pipeline.png", "Exemple : Sam dessine la chaine avant de coder."),
    ],
    12: [("ml-biais.png", "Donnees biaisees = predictions biaisees.")],
    13: [("ml-scikit.png", "Scikit-learn : fit, transform, predict.")],
    14: [("ml-retenir.png", "Boucle : question, donnees, split, baseline, metrique.")],
    15: [("ml-atelier-regression.png", "Atelier regression : donnees, modele, mesure.")],
    16: [("ml-atelier-classification.png", "Atelier classification : labels, split, metriques.")],
    17: [("ml-atelier-pipeline.png", "Atelier pipeline : une seule chaine propre.")],
    18: [("ml-erreurs.png", "Erreurs classiques : train, fuite, accuracy, biais.")],
    19: [("ml-pratiques.png", "Bonnes pratiques : baseline, limites, sous-groupes.")],
    20: [("ml-quiz.png", "Quiz : verifier ce que tu as compris.")],
    21: [("ml-felicitations.png", "Bravo. Tu as les bases du machine learning.")],
}

COVER_IMAGE = "ml-couverture.png"

BOOK_TITLE = "IA - Machine Learning"
BOOK_SHORT = "Machine Learning"
BOOK_LEAD = "Supervise, metriques, overfitting et pipelines : les bases du ML sans jargon opaque."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant machine learning"
BOOK_KEYWORDS = "machine learning, regression, classification, overfitting, scikit-learn, formation"
...
def inject_figures(
    ...
    *,
    ...
    schemas = [(src, cap) for src, cap in figures if not str(src).startswith("ml-scene-")]
    scenes = [(src, cap) for src, cap in figures if str(src).startswith("ml-scene-")]
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation IA - Machine Learning</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre IA Machine Learning + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "ia-machine-learning-eco.pdf" if args.eco else "ia-machine-learning.pdf"
    )
