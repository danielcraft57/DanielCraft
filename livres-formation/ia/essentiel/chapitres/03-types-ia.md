...
Lea utilise surtout la generation de texte pour ses propositions. Max utilise la reformulation et parfois la dictée (multimodal leger). Sam utilise la generation pour des exemples pedagogiques, puis filtre. Aucun des trois n'a besoin de tout maitriser. Ils ont besoin de savoir quel type d'outil ils tiennent.
...
Prends trois outils que tu as vus cette semaine (meme dans la pub). Classe-les : prediction, generation, multimodal, agent. Si tu hesites, note pourquoi. L'hesitation est deja de l'apprentissage.
