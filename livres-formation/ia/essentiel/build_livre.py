#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre IA - Les bases et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "ia-les-bases.pdf"

CHAPTER_FILES = [
    "01-cest-quoi.md",
    "02-histoire-simple.md",
    "03-types-ia.md",
    "04-llm-chatgpt.md",
    "05-prompts.md",
    "06-limites-hallucinations.md",
    "07-outils-quotidien.md",
    "08-image-audio-video.md",
    "09-agents-idee.md",
    "10-ethique-rgpd.md",
    "11-travail-metiers.md",
    "12-mini-projet.md",
    "13-retenir.md",
    "14-atelier-prompts.md",
    "15-atelier-workflow.md",
    "16-atelier-verif.md",
    "17-choisir-outil.md",
    "18-securite.md",
  ...
  <div class="page">
    <header class="cover">
      ...
      <div class="cover-copy">
        <div class="cover-kicker">Formation IA</div>
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre IA Les bases + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "ia-les-bases-eco.pdf" if args.eco else "ia-les-bases.pdf"
    )
