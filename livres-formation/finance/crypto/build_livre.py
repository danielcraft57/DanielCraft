#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Finance - Cryptomonnaies et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "finance-crypto.pdf"
...
CHAPTER_FILES = [
    ...
    "12-mini-projet.md",
    "13-retenir.md",
    "14-atelier-wallet.md",
    "15-atelier-portefeuille.md",
    "16-arnaques.md",
    "17-bonnes-pratiques.md",
    "18-securite.md",
    "19-staking-mining.md",
    "20-quiz.md",
    "21-bravo.md",
]
...
COVER_IMAGE = "fin-crypto-couverture.png"

BOOK_TITLE = "Finance - Cryptomonnaies"
BOOK_SHORT = "Finance - Cryptomonnaies"
BOOK_LEAD = "Blockchain, Bitcoin, Ethereum, wallets, exchanges, DeFi, regulation FR, taxes et prudence."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation cryptomonnaies France 2026"
BOOK_KEYWORDS = "crypto, bitcoin, ethereum, wallet, DeFi, regulation, formation"
...
def resolve_source_asset(name: str) -> Path:
    ...
    if name.endswith(".png"):
        ...
        if svg_same.exists():
            return svg_same
        core = name.replace("fin-crypto-", "").replace(".png", "")
...
def main() -> int:
    import argparse
    parser = argparse.ArgumentParser(description="Assemble Finance - Cryptomonnaies + PDF")
    ...
    pdf_name = args.pdf_name or "finance-crypto.pdf"
