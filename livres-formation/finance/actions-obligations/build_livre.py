#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Finance - Actions et obligations et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "finance-actions-obligations.pdf"

CHAPTER_FILES = [
    "01-realite-marches.md",
    "02-cest-quoi-action.md",
    "03-cest-quoi-obligation.md",
    "04-indices.md",
    "05-pea-cto.md",
    "06-lire-bilan.md",
    "07-per-dividendes.md",
    "08-coupons-obligations.md",
    "09-courbe-taux.md",
    "10-duration.md",
    "11-risque-credit.md",
    "12-diversification.md",
    "13-mini-projet.md",
    "14-retenir.md",
    "15-atelier-action.md",
    "16-atelier-obligation.md",
    "17-ipo-pieges.md",
    "18-arnaques.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    1: [
        ("fin-act-realite-marches.png", "La realite des marches actions et oblig..."),
    ],
    2: [
        ("fin-act-action.png", "C'est quoi une action ?"),
    ],
    3: [
        ("fin-act-obligation.png", "C'est quoi une obligation ?"),
    ],
    4: [
        ("fin-act-indices.png", "Indices et paniers"),
    ],
    5: [
        ("fin-act-pea-cto.png", "PEA et CTO : enveloppes utiles"),
    ],
    6: [
        ("fin-act-bilan.png", "Lire un bilan (sans devenir comptable)"),
        ("fin-act-scene-bilan.png", "Exemple : lire un bilan simplifie."),
    ],
    7: [
        ("fin-act-per-div.png", "PER et dividendes"),
    ],
    8: [
        ("fin-act-coupons.png", "Coupons et obligations"),
    ],
    9: [
        ("fin-act-courbe.png", "La courbe des taux"),
    ],
    10: [
        ("fin-act-duration.png", "Duration : sensibilite aux taux"),
    ],
    11: [
        ("fin-act-credit.png", "Risque de credit"),
    ],
    12: [
        ("fin-act-diversif.png", "Diversifier actions et obligations"),
    ],
    13: [
        ("fin-act-mini-projet.png", "Mini-projet : portefeuille pedagogique"),
        ("fin-act-scene-portefeuille.png", "Exemple : poches A/B/C sur papier."),
    ],
    14: [
        ("fin-act-retenir.png", "Retenir l'essentiel"),
    ],
    15: [
        ("fin-act-atelier-action.png", "Atelier : analyser une action fictive"),
        ("fin-act-scene-action.png", "Exemple : analyser une action fictive."),
    ],
    16: [
        ("fin-act-atelier-obligation.png", "Atelier : lire une obligation"),
    ],
    17: [
        ("fin-act-ipo.png", "IPO et pieges du neuf"),
    ],
    18: [
        ("fin-act-arnaques.png", "Arnaques et signaux orange"),
    ],
    19: [
        ("fin-act-bonnes.png", "Bonnes pratiques durable"),
    ],
    20: [
        ("fin-act-quiz.png", "Quiz final"),
    ],
    21: [
        ("fin-act-felicitations.png", "Bravo"),
    ],
}

COVER_IMAGE = "fin-act-couverture.png"

BOOK_TITLE = "Finance - Actions et obligations"
BOOK_SHORT = "Finance - Actions et obligations"
BOOK_LEAD = "Actions, obligations, indices, PEA/CTO, bilan, duration, diversification et portefeuille prudent."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation actions et obligations France 2026"
BOOK_KEYWORDS = "actions, obligations, PEA, CTO, duration, diversification, formation"
...
def main() -> int:
    import argparse
    parser = argparse.ArgumentParser(description="Assemble Finance - Actions et obligations + PDF")
    ...
    pdf_name = args.pdf_name or "finance-actions-obligations.pdf"
