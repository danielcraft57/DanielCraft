#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Assemble le livre Finance - Les bases et genere un PDF telechargeable."""
...
OUT_PDF = ROOT.parent.parent / "pdf" / "finance-les-bases.pdf"
...
CHAPTER_FILES = [
    ...
    "06-interets.md",
    "07-compte-banque.md",
    "08-entreprise-tresorerie.md",
    "09-couts-marge.md",
    "10-devis-facture.md",
    "11-impots-idee.md",
    "12-mini-projet.md",
    "13-retenir.md",
    "14-atelier-budget.md",
    "15-atelier-tresorerie.md",
    "16-atelier-prix.md",
    "17-investir-prudence.md",
    "18-arnaques.md",
...
CHAPTER_IMAGES: dict[int, list[tuple[str, str]]] = {
    ...
    12: [("fin-projet.png", "Mini-projet : ton budget ou ta tresorerie claire.")],
    13: [("fin-retenir.png", "La carte finance en une page.")],
    14: [("fin-atelier-budget.png", "Comparer des offres bancaires proprement.")],
    15: [("fin-atelier-etf.png", "Lire une fiche ETF sans te noyer.")],
    16: [("fin-atelier-risque.png", "Dessiner un profil de risque honnete.")],
    17: [("fin-investir-prudence.png", "Prudence : horizon, poche, sommeil.")],
    18: [("fin-arnaques.png", "Rendement + urgence + secret = danger.")],
    19: [("fin-pratiques.png", "Petites routines qui evitent les grosses erreurs.")],
    20: [("fin-quiz.png", "Verifier sans inventer.")],
    21: [("fin-felicitations.png", "Bravo. Tu as une boussole pour l'argent.")],
}

COVER_IMAGE = "fin-couverture.png"

BOOK_TITLE = "Finance - Les bases"
BOOK_SHORT = "Finance - Les bases"
BOOK_LEAD = "Budget, epargne, tresorerie et prudence : comprendre l'argent sans jargon."
BOOK_AUTHOR = "DanielCraft"
BOOK_SUBJECT = "Formation debutant finance personnelle et petite entreprise"
BOOK_KEYWORDS = "finance, budget, epargne, tresorerie, credit, formation, debutant"
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Assemble le livre Finance Les bases + PDF")
    parser.add_argument(
        "--eco",
        action="store_true",
    ...
    pdf_name = args.pdf_name or (
        "finance-les-bases-eco.pdf" if args.eco else "finance-les-bases.pdf"
    )
